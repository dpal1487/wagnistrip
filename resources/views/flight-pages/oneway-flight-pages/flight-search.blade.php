...
@section('body')
    ...
    <style>
        ...
        .ui-widget-content {
            ...
            background: #eeeeee url(/assets/images/backimg.jpg) 50% top repeat-x;
            color: #333333;
        }
        ...
        .ui-widget-content .ui-state-default {
            ...
            background: #f6f6f6 url(/assets/images/backimg.jpg) 50% 50% repeat-x;
            font-weight: bold;
            color: #1c94c4;
            outline: none;
        }
            ...
            <div class="row">
                <aside class="airlineFilter col-sm-3">
                    <div class="filterstickydiv">
                        <div class="commonTitle_1 cursorPointer  filterheads fontWeight_600 mb-2" data-toggle="collapse"
                            data-target="#FILTER" aria-expanded="true">FILTER <span class="float-right"><i
                                    class="fa fa-arrow-down" aria-hidden="true"></i></span></div>
                        <div class="bg-white filtersinnerdiv">
                            <div class="collapse show" id="FILTER">
                                <div class="accFiltesDiv">
                                    <div class="commonDesc filterheads cursorPointer fontWeight_600" data-toggle="collapse"
                                        data-target="#Stops2,#Airline2" aria-expanded="true">Popular Filters <span
                                            class="float-right"><i class="fa fa-arrow-down" aria-hidden="true"></i></span>
                                    </div>
                                ...
                                <div class="accFiltesDiv">
                                    <div class="commonDesc filterheads cursorPointer fontWeight_600" data-toggle="collapse"
                                        data-target="#price">Pricing <span class="float-right"><i class="fa fa-arrow-down"
                                        ...
                                        <div class="wrapper text-center">
                                            <div class="text-center" style=" margin-top: 1rem; width:100%; ">
                                                <input type="number" min=0 max="9900"
                                                    oninput="validity.valid||(value='3400');" id="min_price"
                                                    class="price-range-field text-center" style="border:none; " readonly />
                                            </div>
                                            <div id="slider-range">
                                                <div class="ui-slider-range ui-widget-header"
                                                    style="left: 0%; width: 100%;"></div>
                                                <a class="ui-slider-handle ui-state-default ui-corner-all"
                                                    style="left: 0%; border: 2px solid;"></a>
                                            </div>
                                            <select
                                                class="form-control1 w-100 border rounded-10 commonDesc mt-4  text-center cursorPointer"
                                                name="price-sorting">
                                ...
                                <div class="accFiltesDiv">
                                    <div class="commonDesc filterheads cursorPointer fontWeight_600" data-toggle="collapse"
                                        data-target="#FLIGHT">FLIGHT TIMING <span class="float-right"><i
                                                class="fa fa-arrow-down" aria-hidden="true"></i></span></div>
                                                ...
                                                <div class="col-md-3 p-1 timeBTN">
                                                    <div class="card another-card take-off-timing">
                                                        <div class="text-center">
                                                            ...
                                                            <small class="beforesixam" style="font-size:8px;">Before 6 AM
                                                            </small><br>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-3 p-1 timeBTN">
                                                    <div class="card another-card take-off-timing ">
                                                        <div class="text-center">
                                                            ...
                                                            <small class="beforesixam" style="font-size:8px;">6 Am - 12
                                                                Pm</small><br>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-3 p-1 timeBTN">
                                                    <div class="card another-card take-off-timing ">
                                                        <div class="text-center">
                                                            ...
                                                            <small class="beforesixam" style="font-size:8px;">12 Pm - 6
                                                                Pm</small><br>
                                                ...
                                                <div class="col-md-3 p-1 timeBTN">
                                                    <div class="card another-card take-off-timing ">
                                                        <div class="text-center">
                                                            ...
                                                            <small class="beforesixam" style="font-size:8px;">After 6
                                                                Pm</small><br>
                                                            {{-- <small style="font-size:10px;">$ 65225</small> --}}
                                                        </div>
                                                    </div>
                                ...
                                @if (isset($itineraries['Itineraries']['Itinerary'][0]) && isset($itineraries['Itineraries']['Itinerary'][1]) && !isset($itineraries['Itineraries']['Itinerary'][2]))
                                    @php
                                        ...
                                        array_push($airlineArr, [
                                            'code' => $itineraries['Itineraries']['Itinerary'][0]['AirLine']['Code'],
                                            'name' => $itineraries['Itineraries']['Itinerary'][0]['AirLine']['Name'],
                                            'stop' => '1-Stop',
                                            'layover' =>
                                                $itineraries['Itineraries']['Itinerary'][0]['Destination'][
                                                    'AirportCode'
                                                ],
                                            'airFare' =>
                                                $itineraries['PricingInfos']['PricingInfo'][0]['FareBreakDowns'][
                                                    'FareBreakDown'
                                                ][0]['TotalFare'],
                                        ]);
                                    @endphp

                                    <div class="flightcardwrapper bg-white rounded-10 1-Stop {{ $itineraries['Itineraries']['Itinerary'][0]['AirLine']['Code'] . ' ' . $itineraries['Itineraries']['Itinerary'][0]['Destination']['AirportCode'] }} "
                                        data-price1="{{ $itineraries['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['TotalFare'] }}">
                                        <div
                                            class="detailinner d-flex justify-content-between align-items-center flex-wrap-in-mb">
                                                ...
                                                <div class="airlinelogodiv row">
                                                    <div class="col-2">
                                                        <img src="{{ asset('assets/images/flight/' . $itineraries['Itineraries']['Itinerary'][0]['AirLine']['Code']) }}.png"
                                                            alt="airline" class="airlineimg" loading="lazy">
                                                    </div>
                                                    <div class="airlinename">
                                                        <span
                                                            class="commonpera d-block fontWeight_600">{{ $itineraries['Itineraries']['Itinerary'][0]['AirLine']['Name'] ?? $itineraries['Itineraries']['Itinerary'][0]['AirLine']['Name'] }}</span>
                                                        <span
                                                            class="commonpera d-block fontWeight_600">{{ $itineraries['Itineraries']['Itinerary'][0]['AirLine']['Code'] . '-' . $itineraries['Itineraries']['Itinerary'][0]['AirLine']['Identification'] }}</span>
                                                    </div>
                                                </div>
                                                <div
                                                    class="airlinedetails d-flex justify-content-between align-items-center">
                                                    <div class="divleft col-4">
                                                        <div class="commonDesc fontWeight_600"
                                                            data-city1="{{ $itineraries['Itineraries']['Itinerary'][0]['Origin']['CityName'] . ' (' . $itineraries['Itineraries']['Itinerary'][0]['Origin']['AirportCode'] . ')' }}">
                                                            {{ $itineraries['Itineraries']['Itinerary'][0]['Origin']['CityName'] . ' (' . $itineraries['Itineraries']['Itinerary'][0]['Origin']['AirportCode'] . ')' }}
                                                            <span
                                                                class="commonDesc fontWeight_600">{{ getTimeFormat($itineraries['Itineraries']['Itinerary'][0]['Origin']['DateTime']) }}</span>
                                                        </div>
                                                        <span
                                                            class="fontWeight_600 graytext">{{ getDateFormat($itineraries['Itineraries']['Itinerary'][0]['Origin']['DateTime']) }}</span>
                                                    </div>
                                                    ...
                                                    <div class="divleft col-4">
                                                        <div class="commonDesc fontWeight_600"
                                                            data-city2="{{ $itineraries['Itineraries']['Itinerary'][1]['Destination']['CityName'] . ' (' . $itineraries['Itineraries']['Itinerary'][1]['Destination']['AirportCode'] . ')' }}">
                                                            {{ $itineraries['Itineraries']['Itinerary'][1]['Destination']['CityName'] . ' (' . $itineraries['Itineraries']['Itinerary'][1]['Destination']['AirportCode'] . ')' }}
                                                            <span
                                                                class="commonDesc fontWeight_600">{{ getTimeFormat($itineraries['Itineraries']['Itinerary'][1]['Destination']['DateTime']) }}</span>
                                                        </div>
                                                        <span
                                                            class="graytext fontWeight_600">{{ getDateFormat($itineraries['Itineraries']['Itinerary'][1]['Destination']['DateTime']) }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="buttonsdiv col-sm-3 text-center m-auto">
                                                <form action="{{ route('galileo-pricing') }}" method="POST">
                                                    ...
                                                    @if ($isAgent)
                                                        <strong
                                                            class=" TotalFare product-card commonTitle_1 fontWeight_600 d-block pricetext"
                                                            data-price1="{{ $itineraries['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['TotalFare'] + $charge }}">
                                                            <i
                                                                class="fa fa-rupee"></i>{{ $itineraries['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['TotalFare'] + $charge }}</strong>
                                                    @else
                                                        <strong
                                                            class=" TotalFare product-card commonTitle_1 fontWeight_600 d-block pricetext"
                                                            data-price1="{{ $itineraries['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['BaseFare'] }}">
                                                            <i class="fa fa-rupee"></i>
                                                            {{ $itineraries['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['BaseFare'] }}</strong>
                                                    @endif
                                                    </span>

                                                    <a class="btn btn-sm submit-btn blueBtn commonTitle_1 w-100">Book
                                                        Now</a>
                                        ...
                                        <div class="collapseblediv d-flex justify-content-end">
                                            <span data-toggle="collapse" data-target="#flight-details{{ $AvailKey }}"
                                                class="onewflydetbtn commonDesc fontWeight_600 butonborderd"
                                                aria-expanded="true">Flight Details <i
                                                    class="fa fa-regular fa-angle-down"></i></span>
                                        </div>
                                        <div id="flight-details{{ $AvailKey }}"
                                            class="collapse flightcolaspsedetails">
                                            <div class="wrapperdiv">
                                                <ul class="nav nav-tabs">
                                                    <li class="nav-item"> <a
                                                            class="nav-link commonpera fontWeight_600 active"
                                                            data-toggle="tab" href="#Information{{ $AvailKey }}">
                                                            Flight Information </a></li>
                                                    <li class="nav-item"> <a class="nav-link commonpera fontWeight_600"
                                                            data-toggle="tab" href="#Details{{ $AvailKey }}"> Fare
                                                            Details </a></li>
                                                    <li class="nav-item"> <a class="nav-link commonpera fontWeight_600"
                                                            data-toggle="tab" href="#Baggage{{ $AvailKey }}">Baggage
                                                            Information </a></li>
                                                    <li class="nav-item"> <a class="nav-link commonpera fontWeight_600"
                                                            data-toggle="tab"
                                                            href="#Cancellation{{ $AvailKey }}">Cancellation Rules
                                                        </a></li>
                                                </ul>
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="Information{{ $AvailKey }}">
                                                        <div class="airCodetext py-2">
                                                            <span
                                                                class="commonDesc fontWeight_600">{{ $itineraries['Itineraries']['Itinerary'][0]['Origin']['AirportCode'] }}
                                                                <span class="nextarrow">→</span>
                                                                {{ $itineraries['Itineraries']['Itinerary'][0]['Destination']['AirportCode'] }}
                                                            </span>
                                                            <span
                                                                class="commonpera fontWeight_600">{{ getDateFormat($itineraries['Itineraries']['Itinerary'][0]['Origin']['DateTime']) }}</span>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-2 col-md-2 col-sm-2">
                                                                <img src="{{ asset('assets/images/flight/' . $itineraries['Itineraries']['Itinerary'][0]['AirLine']['Code']) }}.png"
                                                                    alt="fligt" class="airlineimg" loading="lazy">
                                                                <span
                                                                    class="d-block fontWeight_600">{{ $itineraries['Itineraries']['Itinerary'][0]['AirLine']['Code'] . '-' . $itineraries['Itineraries']['Itinerary'][0]['AirLine']['Identification'] }}</span>
                                                            </div>
                                                            ...
                                                            <div class="col-3 col-md-3 col-sm-3 text-center">
                                                                <span class="commonTitle_600 watchicon"><svg
                                                                        ...
                                                                        <g>
                                                                            ...
                                                                            <g clip-path="url(#a)"
                                                                                ...
                                                                                <path d="M0 0v-41.698"
                                                                                    style="stroke-width:30;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;stroke-dasharray:none;stroke-opacity:1"
                                                                                    transform="translate(256 56.698)"
                                                                                    fill="none" stroke="#000000"
                                                                                    stroke-width="30"
                                                                                    stroke-linecap="round"
                                                                                    stroke-linejoin="round"
                                                                                ...
                                                                                <path d="M0 0h51.698"
                                                                                    style="stroke-width:30;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;stroke-dasharray:none;stroke-opacity:1"
                                                                                    transform="translate(445.302 256)"
                                                                                    fill="none" stroke="#000000"
                                                                                    stroke-width="30"
                                                                                    stroke-linecap="round"
                                                                                    stroke-linejoin="round"
                                                                                    ...
                                                                                    data-original="#000000"
                                                                                    class=""></path>
                                                                                <path d="m0 0 26.556-26.556"
                                                                                    style="stroke-width:30;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;stroke-dasharray:none;stroke-opacity:1"
                                                                                    transform="translate(85.587 426.412)"
                                                                                    fill="none" stroke="#000000"
                                                                                    stroke-width="30"
                                                                                    stroke-linecap="round"
                                                                                    stroke-linejoin="round"
                                                                                    ...
                                                                                    data-original="#000000"
                                                                                    class=""></path>
                                                                                <path d="m0 0 26.557-26.556"
                                                                                    style="stroke-width:30;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;stroke-dasharray:none;stroke-opacity:1"
                                                                                    transform="translate(399.856 112.144)"
                                                                                    fill="none" stroke="#000000"
                                                                                    stroke-width="30"
                                                                                    stroke-linecap="round"
                                                                                    stroke-linejoin="round"
                                                                                    ...
                                                                                    data-original="#000000"
                                                                                    class=""></path>
                                                                                <path d="m0 0-26.556-26.557"
                                                                                    style="stroke-width:30;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;stroke-dasharray:none;stroke-opacity:1"
                                                                                    transform="translate(426.412 426.413)"
                                                                                    fill="none" stroke="#000000"
                                                                                    stroke-width="30"
                                                                                    stroke-linecap="round"
                                                                                    stroke-linejoin="round"
                                                                                ...
                                                                                <path d="m0 0-26.556-26.557"
                                                                                    style="stroke-width:30;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;stroke-dasharray:none;stroke-opacity:1"
                                                                                    transform="translate(112.144 112.144)"
                                                                                    fill="none" stroke="#000000"
                                                                                    stroke-width="30"
                                                                                    stroke-linecap="round"
                                                                                    stroke-linejoin="round"
                                                                                    ...
                                                                                    data-original="#000000"
                                                                                    class=""></path>
                                                                                <path d="M0 0v-139.302h94.651"
                                                                                    style="stroke-width:30;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;stroke-dasharray:none;stroke-opacity:1"
                                                                                    transform="translate(256 395.302)"
                                                                                    fill="none" stroke="#000000"
                                                                                    stroke-width="30"
                                                                                    stroke-linecap="round"
                                                                                    stroke-linejoin="round"
                                                                ...
                                                                @php
                                                                    ...
                                                                    $timess = [
                                                                        getTimeFormat(
                                                                            $itineraries['Itineraries']['Itinerary'][0][
                                                                                'Origin'
                                                                            ]['DateTime'],
                                                                        ),
                                                                    ];
                                                            ...
                                                            @php
                                                                ...
                                                                $lay2 = [
                                                                    getTimeFormat(
                                                                        $itineraries['Itineraries']['Itinerary'][1][
                                                                            'Origin'
                                                                        ]['DateTime'],
                                                                    ),
                                                                ];
                                                                ...
                                                                } elseif ($lay1[0] > '12:00' && $lay2[0] > '12:00') {
                                                            ...
                                                            <div class="col-12 col-md-12 col-sm-12 text-center layorDiv">
                                                                <span class="layoretext">LAYOVER:
                                                                    {{ getTimeDff_formated($itineraries['Itineraries']['Itinerary'][0]['Destination']['DateTime'], $itineraries['Itineraries']['Itinerary'][1]['Origin']['DateTime']) }}</span>
                                                            </div>

                                                            <div class="col-12 col-md-12 col-sm-12 airCodetext py-2">
                                                                <span
                                                                    class="commonDesc fontWeight_600">{{ $itineraries['Itineraries']['Itinerary'][1]['Origin']['AirportCode'] }}
                                                                    =>
                                                                    {{ $itineraries['Itineraries']['Itinerary'][1]['Destination']['AirportCode'] }}
                                                                </span>
                                                                <span
                                                                    class="commonpera fontWeight_600">{{ getDateFormat($itineraries['Itineraries']['Itinerary'][1]['Origin']['DateTime']) }}</span>
                                                            </div>
                                                            ...
                                                            <div class="col-2 col-md-2 col-sm-2">
                                                                <img src="{{ asset('assets/images/flight/' . $itineraries['Itineraries']['Itinerary'][1]['AirLine']['Code']) }}.png"
                                                                    alt="fligt" class="airlineimg" loading="lazy">
                                                                <span
                                                                    class="d-block fontWeight_600">{{ $itineraries['Itineraries']['Itinerary'][1]['AirLine']['Code'] . '-' . $itineraries['Itineraries']['Itinerary'][1]['AirLine']['Identification'] }}</span>
                                                            </div>
                                                    ...
                                                    <div class="tab-pane container fade" id="Details{{ $AvailKey }}">
                                                        ...
                                                        <div class="faretextdiv pb-2">
                                                            <span class="text-left commonTitle_1 fontWeight_600"> Fare
                                                                Rules :</span>
                                                            <span
                                                                class="text-right Refundable butonborderd greenborderd">Refundable</span>
                                                        </div>
                                                        <table class="table table-bordered">
                                                            <tbody class="onwfntrespons-11">
                                                                <tr>
                                                                    <td class="commonpera fontWeight_500">1 Adult</td>
                                                                    <td class="text-right"> <i class="fa fa-inr"></i>4255
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="commonpera fontWeight_500">Total (Base Fare)
                                                                    </td>
                                                                    <td class="text-right"> <i class="fa fa-inr"></i>4255
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td class="text-right"> <i class="fa fa-inr"></i>959
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="commonpera fontWeight_500">Total (Fee &amp;
                                                                        Surcharge)</td>
                                                                    <td class="text-right"> <i class="fa fa-inr"></i>5214
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    ...
                                                    <div class="tab-pane container fade" id="Baggage{{ $AvailKey }}">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td class="d-flex align-items-center">
                                                                        <img src="https://www.flights.wagnistrip.com/assets/images/flight/UK.png"
                                                                            alt="" class="airlineimg"
                                                                            loading="lazy">
                                                                        <span
                                                                            class="commonpera fontWeight_500 pl-2">UK-929</span>
                                                                    </td>
                                                        ...
                                                        <span class="commonpera fontWeight_500 font-weight-bold">Terms
                                                            &amp; Conditions</span>
                                                        <ul class="commonpera fontWeight_500">
                                                            ...
                                                            <li>WT does not guarantee the accuracy of cancel reschedule
                                                                fees..</li>
                                                            ...
                                                            <li>Airlines doesnt allow any additional baggage allowance for
                                                                any infant added in the booking</li>
                                                    ...
                                                    <div class="tab-pane container fade"
                                                        id="Cancellation{{ $AvailKey }}">
                                                        <table class="table table-bordered">
                                                            <tbody class="onwfntrespons-11">
                                                                <tr>
                                                                    <td>
                                                                        <b>Time Frame to Reissue</b>
                                                                        <div class="commonpera fontWeight_500">(Before
                                                                            scheduled departure time) </div>
                                                                    </td>
                                                                    <td>
                                                                        <b>Airline Fees</b>
                                                                        <div class="commonpera fontWeight_500"> (per
                                                                            passenger) </div>
                                                                    </td>
                                                                    <td>
                                                                        <b>WT Fees</b>
                                                                ...
                                                                <tr>
                                                                    <td class="commonpera fontWeight_500">Cancel Before 4
                                                                        hours of departure time.</td>
                ...
                <div class="col-sm-3 pt-20">
                    <div class="boxunder ">
                        ...
                        <div id="FILTER">
                            ...
                            <div class="ranjepp">
                                <div class="owstitle pb-10" data-toggle="collapse" data-target="#Stops2,#Airline2">
                                    Popular Filters
                                    <span class="float-right"><i class="fa fa-arrow-down" aria-hidden="true"></i></span>
                                </div>
                                ...
                                <div id="slider-range">
                                    ...
                                    <a class="ui-slider-handle ui-state-default ui-corner-all" style="left: 100%; border: 2px solid;"></a>
                                        ...
                                        <select class="form-control1" name="price-sorting"
                                            style="width: 100%; text-align: center; border-radius: 10px; border: 1px solid #0164a3;">
                                            <option value="0">Sort Price</option>
                                            <option value="l2h">Low - High Price</option>
                                            <option value="h2l">High - Low Price</option>
                                        </select>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 p-1 timeBTN">
                                                <div class="card another-card take-off-timing">
                                                    <div class="text-center">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="26"
                                                            height="26" fill="currentColor" class="bi bi-sunrise-fill"
                                                            viewBox="0 0 16 16">
                                                            <path
                                                                d="M7.646 1.146a.5.5 0 0 1 .708 0l1.5 1.5a.5.5 0 0 1-.708.708L8.5 2.707V4.5a.5.5 0 0 1-1 0V2.707l-.646.647a.5.5 0 1 1-.708-.708l1.5-1.5zM2.343 4.343a.5.5 0 0 1 .707 0l1.414 1.414a.5.5 0 0 1-.707.707L2.343 5.05a.5.5 0 0 1 0-.707zm11.314 0a.5.5 0 0 1 0 .707l-1.414 1.414a.5.5 0 1 1-.707-.707l1.414-1.414a.5.5 0 0 1 .707 0zM11.709 11.5a4 4 0 1 0-7.418 0H.5a.5.5 0 0 0 0 1h15a.5.5 0 0 0 0-1h-3.79zM0 10a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2A.5.5 0 0 1 0 10zm13 0a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5z" />
                                                        </svg><br />
                                            ...
                                            <div class="col-md-3 p-1 timeBTN">
                                                <div class="card another-card take-off-timing ">
                                                    <div class="text-center">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="26"
                                                            height="26" fill="currentColor" class="bi bi-sunset-fill"
                                                            viewBox="0 0 16 16">
                                                            <path
                                                                d="M7.646 4.854a.5.5 0 0 0 .708 0l1.5-1.5a.5.5 0 0 0-.708-.708l-.646.647V1.5a.5.5 0 0 0-1 0v1.793l-.646-.647a.5.5 0 1 0-.708.708l1.5 1.5zm-5.303-.51a.5.5 0 0 1 .707 0l1.414 1.413a.5.5 0 0 1-.707.707L2.343 5.05a.5.5 0 0 1 0-.707zm11.314 0a.5.5 0 0 1 0 .706l-1.414 1.414a.5.5 0 1 1-.707-.707l1.414-1.414a.5.5 0 0 1 .707 0zM11.709 11.5a4 4 0 1 0-7.418 0H.5a.5.5 0 0 0 0 1h15a.5.5 0 0 0 0-1h-3.79zM0 10a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2A.5.5 0 0 1 0 10zm13 0a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5z" />
                                                        </svg><br />
                                            ...
                                            <div class="col-md-3 p-1 timeBTN">
                                                <div class="card another-card take-off-timing ">
                                                    <div class="text-center">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="20"
                                                            height="20" fill="currentColor" class="bi bi-moon-fill"
                                                            viewBox="0 0 16 16">
                                                            <path
                                                                d="M6 .278a.768.768 0 0 1 .08.858 7.208 7.208 0 0 0-.878 3.46c0 4.021 3.278 7.277 7.318 7.277.527 0 1.04-.055 1.533-.16a.787.787 0 0 1 .81.316.733.733 0 0 1-.031.893A8.349 8.349 0 0 1 8.344 16C3.734 16 0 12.286 0 7.71 0 4.266 2.114 1.312 5.124.06A.752.752 0 0 1 6 .278z" />
                                                        </svg><br />
                ...
                <div class="col-sm-9 pt-20" id="flightMainCard">
                    ...
                    <div id="scrollfix " class="scrollfix isotope-grid">
                        <div class="too-many-filters" style="display: none; text-align:center; margin-top:10rem;">
                            ...
                            <p>No Flight Found for this Time....Click to remove..<span class="close-btn2 btn btn-danger"
                                    style="cursor: pointer;">X</span></p>
                        </div>
                        {{--
                        @if (!empty($availability))
                            @php
                            ...
                            @foreach ($availability['Availibilities'][0]['Availibility'] as $AvailKey => $itineraries)
                                @if (isset($itineraries['Itineraries']['Itinerary'][0]) && isset($itineraries['Itineraries']['Itinerary'][1]) && !isset($itineraries['Itineraries']['Itinerary'][2]))
                                    ...
                                    <div class="cardlist take airline_hide stops_hide 1-Stop {{ $itineraries['Itineraries']['Itinerary'][0]['AirLine']['Code'] . ' ' . $itineraries['Itineraries']['Itinerary'][0]['Destination']['AirportCode'] }} "
                                        data-price1="{{ $itineraries['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['TotalFare'] }}">
                                        <div class="" >
                                        <div class="boxunder grid-item takingoff">
                                            ...
                                            <div class="boxunder">
                                                <div class="row">
                                                    <div class="col-5 col-md-5 col-sm-5 text-center">
                                                        ...
                                                        <div class="searchtitle cityflight"
                                                            data-city1="{{ $itineraries['Itineraries']['Itinerary'][0]['Origin']['CityName'] . ' (' . $itineraries['Itineraries']['Itinerary'][0]['Origin']['AirportCode'] . ')' }}">
                                                            {{ $itineraries['Itineraries']['Itinerary'][0]['Origin']['CityName'] . ' (' . $itineraries['Itineraries']['Itinerary'][0]['Origin']['AirportCode'] . ')' }}
                                                            <span class=" takeoff">
                                                                {{ getTimeFormat($itineraries['Itineraries']['Itinerary'][0]['Origin']['DateTime']) }}</span>
                                                        </div>
                                                    ...
                                                    <div class="col-5 col-md-5 col-sm-5">
                                                        <div class="text-center">
                                                            <div class="searchtitle cityflight"
                                                                ...
                                                                {{ $itineraries['Itineraries']['Itinerary'][1]['Destination']['CityName'] . ' (' . $itineraries['Itineraries']['Itinerary'][1]['Destination']['AirportCode'] . ')' }}
                                                                <span
                                                                    class=" landing">{{ getTimeFormat($itineraries['Itineraries']['Itinerary'][1]['Destination']['DateTime']) }}</span>
                                                            </div>
                                                            <div class="searchtitle colorgrey">
                                                                {{ getDateFormat($itineraries['Itineraries']['Itinerary'][1]['Destination']['DateTime']) }}
                                                            </div>
                                            ...
                                            <div class="container pt-10 pb-10">
                                                ...
                                                <span data-toggle="collapse"
                                                    data-target="#flight-details1{{ $AvailKey }}"
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <div class="tab-pane container fade"
                                                            ...
                                                            <div class="onwfntrespons-11">
                                                                ...
                                                                <span
                                                                    class="text-right {{ $itineraries['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['Refundable'] }}">
                                ...
                                @elseif (isset($itineraries['Itineraries']['Itinerary'][0]) && !isset($itineraries['Itineraries']['Itinerary'][1]))
                                    @php
                                    ...
                                    @endphp
                                    <div class="cardlist take airline_hide stops_hide Non-Stop {{ $itineraries['Itineraries']['Itinerary'][0]['AirLine']['Code'] }}"
                                        data-price1="{{ $itineraries['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['TotalFare'] }}">
                                        <div class="grid-item" >
                                        <div class="boxunder grid-item takingoff">
                                            <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-4 col-md-4 col-sm-4 marginleft-20">
                                                        ...
                                                        <div class="searchtitle">
                                                            {{ $itineraries['Itineraries']['Itinerary'][0]['Origin']['CityName'] . ' (' . $itineraries['Itineraries']['Itinerary'][0]['Origin']['AirportCode'] . ')' }}
                                                            <span
                                                                class=" takeoff">{{ getTimeFormat($itineraries['Itineraries']['Itinerary'][0]['Origin']['DateTime']) }}</span>
                                                        </div>
                                                        <div class="searchtitle colorgrey">
                                                            {{ getDateFormat($itineraries['Itineraries']['Itinerary'][0]['Origin']['DateTime']) }}
                                                        </div>
                                                    ...
                                                    <div class="col-5 col-md-5 col-sm-5">
                                                        <div class="text-center">
                                                            <div class="searchtitle">
                                                                {{ $itineraries['Itineraries']['Itinerary'][0]['Destination']['CityName'] . ' (' . $itineraries['Itineraries']['Itinerary'][0]['Destination']['AirportCode'] . ')' }}
                                                                <span
                                                                    class=" landing">{{ getTimeFormat($itineraries['Itineraries']['Itinerary'][0]['Destination']['DateTime']) }}</span>
                                                            </div>
                                                            <div class="searchtitle colorgrey">
                                                                {{ getDateFormat($itineraries['Itineraries']['Itinerary'][0]['Destination']['DateTime']) }}
                                                            </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        const deskiata = {
            ...
            "RB": "Syrianair",
            "TA": "TACA",
            "PZ": "Transportes airline",
            "JJ": "Linhas Airline",
            "TP": "Air Portugal",
            "RO": "TAROM S.A.",
            "SF": "Tassili ",
            "TG": "Thai Airways",
            "TK": "Turkish Airlines ️",
            "3V": "TNT Airways",
            "UN": "Transaero",
        ...
        arrfilterline.forEach(element => {
            airlineLoop = '<div class="padding-10 input_row12">' +
                '<span class="span_input"><input type="checkbox" class="form-check-input" value="' +
                element.code + '">' + '<img src="{{ asset('assets/images/flight/') }}/' + element
                .code + '.png" width="20px" height="20px" alt="">' + deskiata[element.name] +
                ' </span>' +
        ...
        arrfilterStop.forEach(element => {
            airlineStopLoop =
                '<div class="input_row"><input type="checkbox" class="form-check-input" value="' +
        ...
        function showMatchingCardLists() {
            ...
            closeBtn.on('click', function() {
                ...
                $("#Airline :checkbox:checked, #Airline2 :checkbox:checked, #Stops :checkbox:checked, #Stops2 :checkbox:checked")
                    .prop('checked', false);
            ...
            if (airlineArr.length > 0 && stopsArr.length > 0 && activeButton.length > 0 && activeButton2
                .length > 0) {
                var filteredCards = $(".airline_hide" + airlineArr.join(", .airline_hide") + stopsArr.join(
                    ", .stops_hide") + activeButton.join(", .airline_hide") + activeButton2.join(
                    ", .airline_hide"));
