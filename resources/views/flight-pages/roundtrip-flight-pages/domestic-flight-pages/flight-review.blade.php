...
@endphp
                        ...
                        <div class="boxunder p-2">
                            ...
                            <div class="ranjepp">
                                ...
                                <div id="price" class="collapse show">
                                    <span class="font-14">
                                        ...
                                        <i class="fa fa-inr"></i>
                                        {{ array_sum([$newFare[0]->fareInfoGroup->fareAmount->monetaryDetails->amount, $newFare2[0]->fareInfoGroup->fareAmount->monetaryDetails->amount]) . ')' }}

                                    </span>
                                    <span class="float-right fontsize-17"><i class="fa fa-inr"></i>
                                        {{ (int) $newFare[0]->numberOfPax->segmentControlDetails->numberOfUnits * (int) array_sum([$newFare[0]->fareInfoGroup->fareAmount->monetaryDetails->amount, $newFare2[0]->fareInfoGroup->fareAmount->monetaryDetails->amount]) }}
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="ranjepp">
                                ...
                                <div id="price" class="collapse show">
                                    ...
                                    <span class="float-right fontsize-17"><i class="fa fa-inr"></i>
                                        {{((int) $newFare[0]->numberOfPax->segmentControlDetails->numberOfUnits * $Charge) +  (int) $newFare[0]->numberOfPax->segmentControlDetails->numberOfUnits * (int) array_sum([(int)($newFare[0]->fareInfoGroup->fareAmount->otherMonetaryDetails->amount), ($newFare2[0]->fareInfoGroup->fareAmount->otherMonetaryDetails->amount)]) - (int) $newFare[0]->numberOfPax->segmentControlDetails->numberOfUnits * (int) array_sum([$newFare[0]->fareInfoGroup->fareAmount->monetaryDetails->amount, $newFare2[0]->fareInfoGroup->fareAmount->monetaryDetails->amount]) }}
                                    </span>
                                </div>
                            </div>
                            <div class="border-bottom"></div>
                            <div class="ranjepp">
                                ...
                                <span class="float-right fontsize-17"><i class="fa fa-inr"></i> <span id="ChaAm">10</span></span>
                                  
                                </div>
                                </div>
                                 <div id="price" class="collapse show">
                                    <span class="font-14">Discount </span>
                                    <span class="float-right fontsize-17"><i class="fa fa-inr"></i> <span id="DisAm">0</span></span>
                                </div> 
                                <div id="price" class="collapse show">
                            ...
                            <div class="ranjepp">
                                ...
                                <div class="p-1">
                                    <span class="font-14">
                                        ...
                                        <i class="fa fa-inr"></i>
                                        {{ array_sum([$newFare[1]->fareInfoGroup->fareAmount->monetaryDetails->amount, $newFare2[1]->fareInfoGroup->fareAmount->monetaryDetails->amount]) . ')' }}

                                    </span>
                                    <span class="float-right fontsize-17"><i class="fa fa-inr"></i>
                                        {{ (int) $newFare[1]->numberOfPax->segmentControlDetails->numberOfUnits * (int) array_sum([$newFare[1]->fareInfoGroup->fareAmount->monetaryDetails->amount, $newFare2[1]->fareInfoGroup->fareAmount->monetaryDetails->amount]) }}
                                    </span>
                                </div>
                            </div>
 ...
 Surcharges
                                ...
                                <div class="p-1">
                                    <span class="font-14">Total Fee & Surcharges : </span>
                                    <span class="float-right fontsize-17"><i class="fa fa-inr"></i>
                                        {{ ((int) $newFare[0]->numberOfPax->segmentControlDetails->numberOfUnits* $Charge) + array_sum([(int) $newFare[0]->numberOfPax->segmentControlDetails->numberOfUnits * (int) array_sum([$newFare[0]->fareInfoGroup->fareAmount->otherMonetaryDetails->amount, $newFare2[0]->fareInfoGroup->fareAmount->otherMonetaryDetails->amount]), $newFare[1]->numberOfPax->segmentControlDetails->numberOfUnits * (int) array_sum([$newFare[1]->fareInfoGroup->fareAmount->otherMonetaryDetails->amount, $newFare2[1]->fareInfoGroup->fareAmount->otherMonetaryDetails->amount])]) - array_sum([(int) $newFare[0]->numberOfPax->segmentControlDetails->numberOfUnits * (int) array_sum([$newFare[0]->fareInfoGroup->fareAmount->monetaryDetails->amount, $newFare2[0]->fareInfoGroup->fareAmount->monetaryDetails->amount]), $newFare[1]->numberOfPax->segmentControlDetails->numberOfUnits * (int) array_sum([$newFare[1]->fareInfoGroup->fareAmount->monetaryDetails->amount, $newFare2[1]->fareInfoGroup->fareAmount->monetaryDetails->amount])]) }}
                                    </span>
                                </div>
                            </div>
                            <div class="border-bottom"></div>
                            ...
                            <div class="ranjepp">
                                ...
                                <div class="p-1">
                                    <span class="font-14">
                                        ...
                                        <i class="fa fa-inr"></i>
                                        {{ array_sum([$newFare[2]->fareInfoGroup->fareAmount->monetaryDetails->amount, $newFare2[2]->fareInfoGroup->fareAmount->monetaryDetails->amount]) . ')' }}

                                    </span>
                                    <span class="float-right fontsize-17"><i class="fa fa-inr"></i>
                                        {{ (int) $newFare[2]->numberOfPax->segmentControlDetails->numberOfUnits * (int) array_sum([$newFare[2]->fareInfoGroup->fareAmount->monetaryDetails->amount, $newFare2[2]->fareInfoGroup->fareAmount->monetaryDetails->amount]) }}
                                    </span>
                                </div>
                            </div>
                            <div class="border-bottom"></div>
