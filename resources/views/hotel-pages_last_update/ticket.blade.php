                    ...
                    <div class="col-sm-12 borderfadshow pt-20 pb-20">
                        ...
                        <h6 class="text-center"> Kindly print this confirmation and have it
                            ...
                            <div class="container mt-5 mb-5">
                                <button onclick="window.print();" class="padding 10px; btn btn-sm btn-outline-secondary bshadow">
                                    <a style=" color:#0164a3 padding: 5px; display: block;
                                    <i class="fa fa-print" aria-hidden="true"></i> Download Ticket
                                </button>
                            </div>
