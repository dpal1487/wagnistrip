                        ...
                        <div class="boxunder p-2">
                            ...
                            <div class="ranjepp">
                                ...
                                <div id="price" class="collapse show">
                                    ...
                                    @endphp
                                        ...
                                        {{ array_sum([$monetaryDetails, $fareGal[0]['FareBreakDowns']['FareBreakDown'][0]['BaseFare']]) }} )
                                    </span>
                                    <span class="float-right fontsize-17"><i class="fa fa-inr"></i>
                                        {{ (int) $newFare[0]->numberOfPax->segmentControlDetails->numberOfUnits * array_sum([(int) $monetaryDetails, $fareGal[0]['FareBreakDowns']['FareBreakDown'][0]['BaseFare']])}}</span>
                                </div>
                            </div>
                            ...
                            <div class="ranjepp">
                                ...
                                <div id="price" class="collapse show">
                                    ...
                                    <span class="float-right fontsize-17"><i class="fa fa-inr"></i>
                                        {{ array_sum([(int) $newFare[0]->numberOfPax->segmentControlDetails->numberOfUnits * (int) $otherMonetaryDetails+$Charge - (int) $newFare[0]->numberOfPax->segmentControlDetails->numberOfUnits * (int) $monetaryDetails, $fareGal[0]['Total']['FuelSurcharge']+$Charge, $fareGal[0]['Total']['OtherTax']]) }}</span>
                                </div>
                            </div>
                            <div class="border-bottom"></div>
                            <div class="ranjepp">
                        ...
                        <div class="boxunder p-2">
                            ...
                            <div class="ranjepp">
                                ...
                                <div class="p-1">
                                    <span class="font-14">
                                        ...
                                        <i class="fa fa-inr"></i>
                                        {{ array_sum([$monetaryDetails_1, $fareGal[0]['FareBreakDowns']['FareBreakDown'][0]['BaseFare']]) }} )
                                    </span>
                                    <span class="float-right fontsize-17"><i class="fa fa-inr"></i>
                                        {{ (int) $newFare[0]->numberOfPax->segmentControlDetails->numberOfUnits * (int) array_sum([$monetaryDetails_1, $fareGal[0]['FareBreakDowns']['FareBreakDown'][0]['BaseFare']]) }}</span>
                                </div>
                                <div class="p-1">
                                    <span class="font-14">
                                        ...
                                        <i class="fa fa-inr"></i>
                                        {{ array_sum([$monetaryDetails_2, $fareGal[0]['FareBreakDowns']['FareBreakDown'][1]['BaseFare']]) }} )
                                    </span>
                                    <span class="float-right fontsize-17"><i class="fa fa-inr"></i>
                                        {{ (int) $newFare[1]->numberOfPax->segmentControlDetails->numberOfUnits * (int) array_sum([$monetaryDetails_2, $fareGal[0]['FareBreakDowns']['FareBreakDown'][1]['BaseFare']]) }}</span>
                                </div>
                            </div>
                            ...
                            <div class="ranjepp">
                                ...
                                <div class="p-1">
                                    <span class="font-14">Total Fee & Surcharges : </span>
                                    <span class="float-right fontsize-17"><i class="fa fa-inr"></i>
                                        {{ array_sum([array_sum([(int) $newFare[0]->numberOfPax->segmentControlDetails->numberOfUnits * (int) $otherMonetaryDetails_1+$Charge, $newFare[1]->numberOfPax->segmentControlDetails->numberOfUnits * (int) $otherMonetaryDetails_2]) - array_sum([(int) $newFare[0]->numberOfPax->segmentControlDetails->numberOfUnits * (int) $monetaryDetails_1, $newFare[1]->numberOfPax->segmentControlDetails->numberOfUnits * (int) $monetaryDetails_2]), $fareGal[0]['Total']['FuelSurcharge'], $fareGal[0]['Total']['OtherTax']]) }}</span>
                                </div>
                            </div>
                            <div class="border-bottom"></div>
                            <div class="ranjepp">
                            ...
                            <div class="ranjepp">
                                ...
                                <div class="p-1">
                                    <span class="font-14">
                                        ...
                                        <i class="fa fa-inr"></i>
                                        {{ array_sum([$monetaryDetails_3, $fareGal[0]['FareBreakDowns']['FareBreakDown'][2]['BaseFare']]) }} )
                                    </span>
                                    <span class="float-right fontsize-17"><i class="fa fa-inr"></i>
                                        {{ (int) $newFare[2]->numberOfPax->segmentControlDetails->numberOfUnits * (int) array_sum([$monetaryDetails_3, $fareGal[0]['FareBreakDowns']['FareBreakDown'][2]['BaseFare']]) }}</span>
                                </div>
                            </div>
                            <div class="border-bottom"></div>
                            <div class="ranjepp">
