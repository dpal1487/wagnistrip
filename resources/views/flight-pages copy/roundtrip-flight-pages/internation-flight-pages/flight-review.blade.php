                        ...
                        <div class="boxunder p-2">
                            ...
                            <div class="ranjepp">
                                ...
                                <div id="price" class="collapse show">
                                    <span class="font-14">Total Fee & Surcharges : </span>
                                    <span class="float-right fontsize-17"><i class="fa fa-inr"></i>
                                        {{ getTotalTaxes_fn($newFare[0]->numberOfPax->segmentControlDetails->numberOfUnits, $newFare[1]->numberOfPax->segmentControlDetails->numberOfUnits, $newFare[2]->numberOfPax->segmentControlDetails->numberOfUnits, $otherMonetaryDetails_1+$Charge, $otherMonetaryDetails_2+$Charge, $otherMonetaryDetails_3, $monetaryDetails_1, $monetaryDetails_2, $monetaryDetails_3) }}</span>
                                </div>
                            </div>
                            <div class="border-bottom"></div>
                            <div class="ranjepp">
