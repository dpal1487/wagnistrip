...
@section('body')
    ...
    if(!isset($hotelDetails['HotelStays']['HotelStay']['BasicPropertyInfo']['@attributes']['HotelCode'])){
        return redirect()->route('error')->with('msg', 'Hotels Not Found Undefined index.');
    }
