                        ...
                        <div class="borderfadshow pb-20">
                            ...
                            <div class="row ranjepp">
                                ...
                                <div class="col-sm-2 text-center">
                                    <h6 class="adulttext"> {{ $requestDetails['adult'] }} Adult </h6>
                                    @if ($requestDetails['child'] == 0)
                                    @else
                                        <h6 class="adulttext"> {{ $requestDetails['child'] }} Child </h6>
                                    @endif
                                    ...
                                    <div class="col-sm-12">
                                        <div class="p-10 bgpolicy">
                                            ...
                                            $RoomRateDescription = $hotelRoomStays['RoomRates']['RoomRate']['RoomRateDescription']['Text'] ?? '';
                                             //dd($RoomRateDescription,$AdditionalDetail);
                                            ?>
