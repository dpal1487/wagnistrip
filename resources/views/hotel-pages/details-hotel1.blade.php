                                        ...
                                        <div class="col-sm-5 pt-10">
                                            <h4> <i class="fa fa-inr"></i>
                                                <?php
                                                 ...
                                                 {{ number_format(round((int)$roomValue['RoomRates']['RoomRate']['Rates']['Rate']['Base']['@attributes']['AmountBeforeTax'] ?? ($roomValue['RoomRates']['RoomRate']['Rates']['Rate'][0]['Base']['@attributes']['AmountBeforeTax'] ?? $roomValue['RoomRates']['RoomRate']['Rates']['Rate'][0]['Base']['@attributes']['AmountAfterTax'] ?? '')) * 20) }}
                                                 @else
                                                 {{ number_format(round((int)$roomValue['RoomRates']['RoomRate']['Rates']['Rate']['Base']['@attributes']['AmountBeforeTax'] ?? ($roomValue['RoomRates']['RoomRate']['Rates']['Rate'][0]['Base']['@attributes']['AmountBeforeTax'] ?? $roomValue['RoomRates']['RoomRate']['Rates']['Rate'][0]['Base']['@attributes']['AmountAfterTax'] ?? ''))) }}
                                                 @endif
                                            </h4>
                                            <span class="onwfnt-11"> + <i class="fa fa-inr"></i>
                                                @if ($Checkbasefare == "AED")
                                                {{ number_format(round(((int)$roomValue['RoomRates']['RoomRate']['Total']['@attributes']['AmountAfterTax'] - ($roomValue['RoomRates']['RoomRate']['Total']['@attributes']['AmountBeforeTax'] ?? $roomValue['RoomRates']['RoomRate']['Total']['@attributes']['AmountAfterTax']) ?? '') / $dayCount) * 20)  }}
                                                @else
                                                {{ number_format(round((int)$roomValue['RoomRates']['RoomRate']['Total']['@attributes']['AmountAfterTax'] - ($roomValue['RoomRates']['RoomRate']['Total']['@attributes']['AmountBeforeTax'] ?? $roomValue['RoomRates']['RoomRate']['Total']['@attributes']['AmountAfterTax']) ?? '') / $dayCount)  }}
                                                @endif
                                                taxes & fees
                                            </span>
                                            <h4 class="pb-20"></h4>
