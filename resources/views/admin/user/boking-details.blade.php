...
<body style="background-color:#fff !important;">
    <div class="container p-0">
        <div class="card-body">
            ...
            <a class="btn float-right btn-sm" href="{{ URL::to('/booking-pdf/flight-booking/' . $bookings->id * 2022) }}">
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <h5 class="m-0">XYZ Booking ID: <strong>{{ $bookings->booking_id }}</strong></h5>
