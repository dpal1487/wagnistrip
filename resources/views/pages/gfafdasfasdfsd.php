<section class="margintoosss pt-6p pb-20" style="">
            ...
            <form id="main-form" action="{{ route('search-flight-results') }}" method="get">
                <div class="card-body ">
                    <div class="radiobox">
                        ...
                        <span class="radio-toolbar">
                            <input type="radio" name="trip-type" class="trip-type" id="roundtrip-btn" value="roundtrip"
                                checked="checked">
                            ...
                            <div class="card-body hoverbg">
                                ...
                                <select class="js-example-basic-single getLocation" name="departure"
                                    ...
                                    <option value="{{ $segments['departure']['iata'] }}">
                                        {{ $segments['departure']['city'] }}
                                        ({{ $segments['departure']['iata'] }})
                                        {{ $segments['departure']['country'] }}
                                    </option>
                                </select>
                                <div class="slitxt">{{ $segments['departure']['airport'] }}</div>
                            </div>
                        </div>
                            ...
                            <div class="card content">
                                <div class="card-body">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <label class="rdocon">
                                            <input type="radio" name="cabinClass" value="p" checked="checked">
                    ...
                    <div class="pt-20 dpnr">
                        <div class="row">
                            <div class="col-md-6">
                                <button type="button" class="btn btn-sm btn-outline-info bshadow">Regular
                                    Fares</button>
                                <button type="button" class="btn btn-sm btn-outline-info bshadow">Armed Forces Fares
                                </button>
                                <button type="button" class="btn btn-sm btn-outline-info bshadow">Students Fares
                                </button>
                                <button type="button" class="btn btn-sm btn-outline-info bshadow">Senior Citizen
                                    Fares
                                </button>
                    ...
                    <div class="pt-20 dpnr">
                        <div class="boxxx">
                            <span>International holiday on your mind? Get customised suggestions on destinations
                                and
                                find the cheapest flights!</span>
                            <span class="float-right">EXPLORE NOW <i class="fa fa-arrow-right"
