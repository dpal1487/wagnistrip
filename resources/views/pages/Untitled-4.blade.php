        ...
        <form id="main-form" action="{{ route('search-flight-results') }}" method="get">
            <div class="card-body ">
                <div class="radiobox">
                    ...
                    <span class="radio-toolbar">
                        <input type="radio" id="optradio" class="trip-type" name="trip-type"
                            value="multicity">
                ...
                <div class="d-flex pt-10">
                    ...
                    <div class="card wd-25 m-2 hoverbg">
                        <div class="card-body ">
                            ...
                            <select class="js-example-basic-single getLocation" name="arrival"
                                id="select2_arrival">
                            ...
                            <div class="card-body">
                                ...
                                <div class="card-body">
                                    ...
                                    <label class="rdocon">
                                        ...
                                        <span
                                            class="checkmark-2 btn-outline-secondary bshadow">Bussiness</span>
                                    </label>
                                    <label class="rdocon">
