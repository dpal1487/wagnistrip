                    ...
                    <div class="d-flex pt-10">
                        <div class="card wd-25 m-2">
                            <div class="card-body hoverbg">
                                <div class="searchtitle">CITY | HOTEL | AREA </div>
                            ...
                            <div class="card content-hotel" id="accordion">
                                <div class="card-header" id="headingOne">
                                    ...
                                    <button type="button" class="btn btn-sm btn-primary float-right htlarrowclass"
                                        data-toggle="collapse" data-target="#roomselcteds" aria-expanded="true"
                                        aria-controls="roomselcteds">
                                        <i class="fa fa-arrow-down"></i>
                                    </button>
                                </div>
                                <input type="hidden" name="room" value="1">
                                <div id="roomselcteds" class="collapse show" aria-labelledby="headingOne"
                                ...
                                <div id="id_startCalendar" class="calendar-widget default-today"
                                    ...
                                    <div class="input-wrapper">
                                        ...
                                        {{-- <input class="date-field" id="type1-start" type="text"
                                            ...
                                            <input type="text" id="CheckInDatePicker" name="datefilter" value="" />
                            ...
                            <div class="card-body">
                                <div id="id_deadlineCalendar" class="calendar-widget default-today-return" tabindex="-1"
                                    ...
                                    <div class="input-wrapper" id="checkreturnradio">
                                        ...
                                        {{-- <input class="date-field" id="type1-deadline" name="returnDate" type="text"
                                            placeholder="CHECK-OUT" readonly> --}}
                                            <input type="text" id="CheckOutDatePicker" name="datechekout" value="" />
                                    </div>
...
<div class="container mobileVes1 hotel_offerssect">
    ...
    <div id="hotelOffer_sec1" class="carousel slide mt-3 mb-3" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <div class="row p-2">
                    <div class="col-sm-4 p-3">
                        <a href="#">
                            <div class="card">
                                <img src="assets/images/flights/29.png" style="height:180px;" alt="">
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-4 p-3">
                        <a href="#">
                            <div class="card">
                                <img src="assets/images/flights/30.png" style="height:180px;" alt="">
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-4 p-3">
                        <a href="#">
                            <div class="card">
                                <img src="assets/images/flights/31.png" style="height:180px;" alt="">
                            </div>
                        </a>
                    </div>
                </div>
            ...
            <div class="carousel-item">
                <div class="row p-2">
                    <div class="col-sm-4 p-3">
                        <a href="#">
                            <div class="card">
                                <img src="assets/images/flights/32.png" style="height:180px;" alt="">
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-4 p-3">
                        <a href="#">
                            <div class="card">
                                <img src="assets/images/flights/33.png" style="height:180px;" alt="">
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-4 p-3">
                        <a href="#">
                            <div class="card">
                                <img src="assets/images/flights/34.png" style="height:180px;" alt="">
                            </div>
                        </a>
                    </div>
                </div>
            ...
            <div class="carousel-item">
                <div class="row p-2">
                    <div class="col-sm-4 p-3">
                        <a href="#">
                            <div class="card">
                                <img src="assets/images/flights/35.png" style="height:180px;" alt="">
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-4 p-3">
                        <a href="#">
                            <div class="card">
                                <img src="assets/images/flights/36.png" style="height:180px;" alt="">
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-4 p-3">
                        <a href="#">
                            <div class="card">
                                <img src="assets/images/flights/37.png" style="height:180px;" alt="">
                            </div>
                        </a>
                    </div>
                </div>
...
<div class="container mobileVes1 type_ofHotelsroom mt-5 mb-5">
    ...
    <div id="hotel_types2" class="carousel slide mt-2 mb-3" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <div class="row p-2">
            ...
            <div class="carousel-item">
                <div class="row p-2">
                    <div class="col-sm-3 p-3">
                        <a href="#">
                            <div class="card text-left">
                                <img class="card-img-top" src="assets/images/hotel/guest1.jpg" alt="">
                                <div class="card-body">
                                    <h5 class="m-0 text-dark hhstsmshol font-weight-bold">Guest House</h5>
                                    <p class="m-0 small">1500+ Hotels</p>
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-3 p-3">
                        <a href="#">
                            <div class="card text-left">
                                <img class="card-img-top" src="assets/images/hotel/cott1.jpg" alt="">
                                <div class="card-body">
                                    <h5 class="m-0 text-dark hhstsmshol font-weight-bold">Cottages</h5>
                                    <p class="m-0 small">5000+ Hotels</p>
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="col-sm-3 p-3">
                        <a href="#">
                            <div class="card text-left">
                                <img class="card-img-top" src="assets/images/hotel/hom1.jpg" alt="">
                                <div class="card-body">
                                    <h5 class="m-0 text-dark hhstsmshol font-weight-bold">Homestay</h5>
                                    <p class="m-0 small">2000+ Hotels</p>
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="col-sm-3 p-3">
                        <a href="#">
                            <div class="card text-left">
                                <img class="card-img-top" src="assets/images/hotel/hostel1.jpg" alt="">
                                <div class="card-body">
                                    <h5 class="m-0 text-dark hhstsmshol font-weight-bold">Hostels</h5>
                                    <p class="m-0 small">2000+ Hotels</p>
                                </div>
                            </div>
                        </a>
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-3 p-3">
            <div class="card">
                ...
                <div class="card-body">
                    <h6 class="m-0 pl-2 font-weight-bold">Nature Getawasy</h6>
                    <p class="m-0 pl-2">For a dash of luxury</p>
                    <a href="#" class="badge text-primary pl-2 badge-light">Read More</a>
                </div>
            </div>
                                        ...
                                        <a href="#">
                                            <div class="card">
                                                <img class="card-img-top" src="assets/images/hotel/Kashmir.jpg"
                                                    alt="Card image cap">
                                                <div class="card-body">
                                                    <h5 class="card-title htslmrhr text-center m-0 font-weight-bold">J &
                                                        K</h5>
                                                    <p class="card-text text-center m-0">Starting at ₹1000</p>
                                                </div>
                                            </div>
...
<div class="container-fluid pt-4" style="background-color: #e4e8ed;">
    <div class="container mobileVes1">
        ...
        <div class="row mt-4">
            <div class="col-sm-6">
                <h6 class="font-weight-bold">
                    Q. How to make a Hotel booking with xyz ?
                </h6>
                <p class="small">
                    <strong>A.</strong> XYZ offers hotel bookings all over the world at affordable rates. If you're travelling
            ...
            <div class="col-sm-6">
                ...
                <p class="small">
                    <strong>A.</strong> XYZ provides you the best hotel in your location. Go to XYZ's website and type
        ...
        <div class="row ">
            <div class="col-sm-6">
                <h6 class="font-weight-bold">
                    Q. How to find the best budgeted Hotel Nearest me?
                </h6>
                <p class="small">
                    <strong>A.</strong> XYZ provides a easy hotel booking procedure at the best rates. Go to XYZ's
                    ...
                    then book the ideal hotel according to your needs.
                </p>
            </div>
            <div class="col-sm-6">
                <h6 class="font-weight-bold">
                    Q. How to apply best deal & offer on our website?
                </h6>
                <p class="small">
                    <strong>A.</strong> There are lots of deals & offers for booking hotels online through XYZ. While all of
...
<script type="text/javascript">
    $(function() {
        ...
        // $('input[name="datechekout"]').daterangepicker({
        //     autoUpdateInput: false,
        //     locale: {
        //         cancelLabel: 'Clear'
        //     }
        ...
        $('input[name="datefilter"]').on('apply.daterangepicker', function(ev, picker) {
            ...
            $('input[name="datechekout"]').val(picker.endDate.format('DD/MM/YYYY'));
        });

        // $('input[name="datechekout"]').on('apply.daterangepicker', function(ev, picker) {
