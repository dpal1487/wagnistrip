    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-sm-8 m-auto">
                <div class="card shadow" style="border: none;  height: 3900px;padding-top:80px;">
                   <div class="row">
                    <div class="col-sm-7">
                        <h1 class="heading-1">
                    ...
                    <h6 class="spn-2">5-star Zurich City
                        Break</h6>
                    <p>
                        <span class="seven">5N/6D</span> Flexi Package
                        <span class="sp-3">Amazing Zurich City Tour Inclusive Deal 5N</span>
                    </p>
                    <div class="pvt-6">
                        <div class="row">
                            <div class="col-sm-4">
                    ...
                    <div class="container" style="padding-top: 10px;">
                        ...
                        <img src="{{ URL::to('/assets/images/package-image/switzlerland.jpg') }}" alt="" style="margin-left: 50px; width: 600px; height: 400px; margin-top:20px">
                        <div class="row">
                            <div class="col-sm-8">
                                <div class="bd-12">
                                    <h6 class="htpvp">PRICE STARTING FROM</h6>
                                    <h6 class="htpvp1">₹40,802.92
                                    </h6>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-8">
                                <div class="bd-12">
                                    ...
                                    <h6 class="htpvp12">Remaz Tours GmbH
                  ...
                  <div id="iti">
                    <div class="container"> 
                        ...
                        <p class="para-67">The city of Zurich, a global center for banking and finance, lies at the north end of Lake Zurich in
                            ...
                            the river toward the 17th-century Rathaus (town hall).
                        ...
                        <div class="container">
                            ...
                            <div class="container">
                                <div class="bd-12">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-5">
                                            <h6 class="hkl">Pick up from Zurich Airport ,
                                                Zürich Airport (ZRH), Flughafenstrasse, Kloten, Zürich
                                                8302, Switzerland                                                
                                            </h6>
                                    ...
                                    <p class="para-677 mt-5">Arrival to Zurich Airport
                                        Meet and assist and transfer to your hotel in Zurich
                            ...
                            <div class="container " style="padding-top: 150px;">
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <h4 class="hd09">Optional Tour</h4>
                                    </div>
                                    </div>
                                          <p class="para-677">  IF you want optional Tour Plesae contact us
                                            </p>
                            ...
                            <div class="container" style="padding-top: 10px;">
                                ...
                                <p class="para-677">Check out your hotel in Zurich and transfer to Zurich Airport for departure
                                    Hotel check out / late check out subject to availability
                                </p>
                            </div>
                            </div>
                            ...
                            <div class="container">
                                ...
                                <h6 class="headerr">Accommodation</h6>
                                     ...
                                     <p class="para-6777"> 5 Nights Accommodation at Novotel Zurich Airport messe(Switzerland) <br><strong>(subject to availability)</strong>
                                        </p>
                            ...
                            <div class="container" >
                                ...
                                <p class="prvr">Daily Buffet ( Breakfast ) at the hotel</p>
                                
                                <h6 class="head-876">Transport
                                </h6>
                                <p class="prvr">Transfer from /to Airport
                                    </p>
