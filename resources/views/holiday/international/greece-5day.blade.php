    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-sm-8 m-auto">
                <div class="card shadow" style="border: none;  height: 4300px;padding-top:80px;">
                    <div class="row">
                        <div class="col-sm-7">
                            <h1 class="heading-1">
                    ...
                    <h6 class="spn-2">2 Island Explorer</h6>
                        <p>
                            <span class="seven">4N/5D</span> Flexi Package
                            <span class="sp-3">Amazing 2 Island Explorer Tour Inclusive Deal 4N</span>
                        </p>
                        ...
                        <div class="container">
                            ...
                            <p class="para-67">Visit Mykonos and Santorini; two of Greece’s most famous and beautiful islands. In this 5-day tour
                                get hypnotised exploring the twisting streets by day and experience the stunning sunsets and fun
                                nightlife in the evenings. The hassle of organising ferries and transport has been taken care of for
                                you so that you can simply enjoy your getaway!                                                                                 
                            </p>
                            </div>
                            </div>
                            <div id="wise">
                            <div class="container">
                                ...
                                <div class="container">
                                    <div class="bd-1">
                                        ...
                                        <p class="para-6771 mt-5">Welcome to Greece! Meet in the lobby around 7:00pm for an informal meeting with your guide andWelcome to Greece! Meet in the lobby around 2:00pm for an informal meeting with your guide and
                                            other tour members. Afterwards, join us for an optional group dinner to get to know your new travel
                                            mates. Accommodation Giannoulaki Hotel - 4 Star Meals Included Breakfast Included Activities
                                            Welcome MeetingOrientation Walk in Mykonos Town Optional Activities Group Dinner                                                                                                
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="container " style="padding-top: 100px;">
                                    ...
                                    <p class="para-6777">The day is yours to soak up the sunshine, swim in the sea or chew through your memory card
                                ...
                                <div class="container " >
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <h6 class="hd09">Mykonos, Santorini</h6>
                                        </div>
                                    </div>
                                ...
                                <div class="container " >
                                    ...
                                    <p class="para-677">We’ve got a free day today. Relax on the red or black sand beaches, wander the streets and
                                        browse through the shops of the main town or take a quad biking tour! Explore the island’s volcano
                                        and check out an active crater and hot springs. The choices are endless! Accommodation New
                                        Haroula Hotel - 3 Star Meals Included Breakfast Optional Activities Quad Biking - EUR 35-55 Wine
                                        Tasting - EUR 30 Volcano Tour - EUR 20.                                                                         
                                    </p>
                                </div>
                                <hr>
                                ...
                                <div class="container">
                                   ...
                                   <p class="prvr">Services of experienced Travel Talk tour leaders                   
                                    </p>
                                    <h6 class="head-876">Meals</h6>
                                    <p class="prvr">4 breakfasts
                                    </p>
                                  ...
                                  <p class="prvr">Economy class ferry
                                    ...
                                    <p class="prvr">Transfers from the ferry ports to the hotels and from hotels to the ferry ports
