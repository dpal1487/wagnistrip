            ...
            <div class="col-sm-8 m-auto">
                <div class="card shadow" style="border: none;padding-top:80px;  height: 5500px;">
                    ...
                    <p>
                        ...
                        <span class="sp-30">Amazing Bali & Gili
                            Islands Tour Inclusive Deal 6N</span>
                    </p>
                    <div class="pvt-6">
                        <div class="row">
                            <div class="col-sm-4">
                    ...
                    <h6 class="ico-3"> <span><i class="fa fa-check" aria-hidden="true"></i></span>Explore Bali's ancient
                        temples</h6>
                    <h6 class="ico-3"> <span><i class="fa fa-check" aria-hidden="true"></i></span>- Experience the
                        beautiful Bali's countryside and rice terraces
                    </h6>
                    <h6 class="ico-3"> <span><i class="fa fa-check" aria-hidden="true"></i></span> Enjoy delicious
                        Indonesian cuisine and get to taste local fruits
                    </h6>
                    <h6 class="ico-3"> <span><i class="fa fa-check" aria-hidden="true"></i></span>Snorkel with turtles
                        and the famous underwater sculptures
                    </h6>
                    <h6 class="ico-3"> <span><i class="fa fa-check" aria-hidden="true"></i>Visit both Gili Air &
                            Trawangan Island
                        </span></h6>
                    <h6 class="ico-3"> <span><i class="fa fa-check" aria-hidden="true"></i>Party the night away on Gili
                            Islands
                        </span></h6>
                    ...
                    <div class="container" style="padding-top: 20px;">
                        ...
                        <img src="{{ URL::to('/assets/images/images/bali2020.gif') }}" alt=""
                            style="width: 600px; margin-left: 50px; margin-top: 40px;">
                        <div class="row mt-5">
                            <div class="col-sm-5">
                                <div class="bd-12">
                        ...
                        <div class="row">
                            <div class="bd-12">
                                <div class="col-sm-12" style="width: 670px;">
                                    ...
                                    <h6 class="htpvp1">Denpasa <i class="fa fa-arrow-right" aria-hidden="true"></i>
                                        Gili Trawangan
                                    </h6>
                                </div>
                            </div>
                    ...
                    <div id="iti">
                        <div class="container mt-5">
                            ...
                            <p class="para-67">
                                Our Bali and Gili islands experience of 7 Days and 6 Nights is the best package if you
                                like to do an
                                island hopping to the most beautiful island of Indonesia. Start from Bali for 4 Days and
                                end in Gili
                    ...
                    <div id="wise">
                        <div class="container mt-5 mb-5">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <h4 class="hd09"> Airport pick up - Spa - Welcome Beach Dinner</h4>
                                </div>
                            </div>
                            ...
                            <div class="container mt-5 mb-5">
                                <div class="bd-1">
                                    ...
                                    <p class="para-6771 mt-5">Arrival in Bali, meet and greet with your tour leader then
                                        check-in afterwards we will head down to
                                        Reborn Spa for a 2 hour relaxing Balinese massage after the long flights to
                                        Bali, you can then relax
                                        or wandering around Kuta or Seminyak areas. In the afternoon with the rest of
                                        your group, we will
                                        head on to Jimbaran Bay famous with its fresh seafood dinner served right on the
                                        beach, it’s time
                                        to relax and enjoy your unforgettable dinner by the beach while listening to the
                                        sounds of crashing
                                        waves.
                            ...
                            <div class="container " style="padding-top: 150px;">
                                ...
                                <p class="para-677">On this second day is a beach day! Pick up time 08:00 am the first
                                    destination to Nusa Dua
                                    translates literally as 'Two Islands' and a center of water sports and beach
                                    activities, continue to
                                    Melasti Beach a beautiful cliff beach with amazing views afterwards visit the Single
                                    Fin bar for an
                            ...
                            <div class="container ">
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <h4 class="hd09">Waterfall - Ubud - Volcano Viewpoint</h4>
                                    </div>
                                </div>
                                <p class="para-677">After breakfast at the hotel, we will go around 08:30 am, trip
                                    ...
                                    plantation for a
                                    walking tour of the local Coffee we'll then continue to Kintamani to see the Batur
                                    volcano, its located
                                    in the plateau area enjoy the volcano views and lunch here afterwards go to
                                    Tegalalang Rice
                                    Terraces, one of the most beautiful views of Bali's rice terraces before returning
                                    to your hotel.
                            ...
                            <div class="container ">
                                ...
                                <p class="para-677">Today we will go around 09:30 am take a window seat to enjoy a
                                    ...
                                    local
                                    fruits. After this second location, continue to Tanah Lot Temple the iconic ocean
                                    temple
                                    in Bali afterwards visit Canggu with its exotic black sand beach swim, learn to surf
                                    or to
                            ...
                            <div class="container ">
                                ...
                                <p class="para-677">It’s time to head to the Gili islands! Check out early today pick up
                                    around 6 - 7 am and we'll go to
                                    Padang Bay port it will take around 1 hour 30 minute to get to Gili Trawangan Island
                                    after check-in,
                                    lunch and take some rest after the boat ride gets ready for an afternoon ride around
                                    the island by
                                    Bicycle tour. Afterward, we'll get ready for an afternoon beachside sunset drinks
                                    located just by
                            ...
                            <div class="container ">
                                ...
                                <p class="para-677">After breakfast, hop into our snorkeling boat. This second day we
                                    will experience the amazing
                                    crystal waters of the Gili Islands from Turtles, School of fish to the amazing
                                    Underwater Sculptures
                                    of Gili Meno Island. Next stop is the Gili Air Island to enjoy some beachside lunch,
                                    after lunch
                                    continues to have a look around the island by only a walking distance, at around 3 -
                                    4 pm back to
                                    the snorkeling boat enjoy the way back to the island while watching the sunset over
                                    the ocean.
                                    We’ll then head out for a delicious farewell dinner before partying the night away
                                    there is range
                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <h4 class="hd09"> Beach Relaxing - Check Out</h4>
                                    </div>
                                </div>
                                <div class="bd-12">
                                    <div class="row">
                                ...
                                <p class="para-677">As this is your last day. After breakfast don’t miss on another
                                    ...
                                    walk along the beach or take some snap-on those famous beach swing. Check out Time!
                                    The fun
                                    doesn't have to stop here if you need to continue to stay on the island or return to
                                    the airport to
                                    catch a flight or even visiting another island in Indonesia we will happy to help
                                    and assist your
                        ...
                        <div class="container">
                            ...
                            <p class="para-677"> 
                                    6 Nights accommodation at 3* Hotel in Bali and Gili Islands, and Nusa Penida Island
                                    (Grandmas
                                    Plus Seminyak Bali, Tir na Nog Gili Trawangan, Lucy's Garden or similiar class) <br>
                               
                              * Please note exact accommodation and details are re-confirmed at time of booking
                                    and subject to
                        ...
                        <div class="container">
                            ...
                            <p class="prvr">A charming Tour Leader/Guide from The Bali trip Mate
                            </p>
                            ...
                            <h6 class="para-6777">To give you maximum flexibility in deciding where, what and with whom to
                                eat other meals are not
                                included. Vegetarian and Vegan food options on request</h6>
                            <h6 class="head-876">Transport
                            </h6>
                            <p class="para-6777">
                                All transport included based on tours itineraryt <br>
                                included. Vegetarian and Vegan food options on request</p>
                            
                            <h6 class="head-876">Others</h6>
                           <p class="para-6777">Spa</p>
                        </div>
                        <!-- NEXT PAGE -->
