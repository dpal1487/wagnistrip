        ...
        <section class="section">
            <div class="containing"
                ...
                <div class="logoAndBookingId">
                    <div class="grid grid-two-column"
                        ...
                        <div class="wagnistrip-logo">
                            <img style="width: 120px;" src="/Images/logo.png" alt="WagnisTrip Logo">
                        </div>
                        <div class="bookingId">
                            <p style="font-size: 12px;">Booking ID:</p>
                ...
                <div class="thanks"
                    ...
                    <div class="grid grid-two-column" style="display: grid;grid-template-columns: repeat(2, 1fr);">
                        ...
                        <div class="flight-details" style="position: relative;right: 120px;">
                            ...
                            <p style="font-size: 18px;color: white;">Gorakhpur-Hyderabad flight is confirmed</p>
                        </div>
                    </div>
                </div>
                <p style="text-align: center;color: #647a97;font-weight: 900;">Web check-in is mandatory & can be done
                ...
                <div class="destination"
                    ...
                    <div class="grid grid-three-column"
                        ...
                        <div class="place" style="width:230px">
                            <p style="color: #fff;text-align: center;">GORAKHPUR TO HYDERABAD</p>
                        </div>
                        <div class="time">
                ...
                <div class="flight">
                    <div class="grid grid-four-column" style=" display: grid;grid-template-columns: repeat(4, 1fr);">
                        <div class="flight-img" style="margin-top: 20px;">
                            <img style="width:30px" src="/Images/flight.png" alt="Indigo Flight Image">
                            <p style="font-size: 12px;">Indigo Airlines</p>
                            <p style="font-size: 12px;position: relative;bottom: 10px;">6E-6318</p>
                        </div>
                        <div class="gorakhpur-details" style="margin-right: 45px;">
                            <h2 style="font-weight: bold;color: #eb6125;text-align: center;">GOP</h2>
                            <p style="font-size: 11px;position: relative;bottom: 18px;text-align: center;">GORAKHPUR</p>
                            <p style="color: #141823;background: #fef8e5;font-weight: bold;text-align: center;position: relative;
                        bottom: 25px;">15:00 hrs, 09 Dec</p>
                            <p style="text-align: center;font-size: 12px;position: relative;bottom: 35px;">Gorakhpur
                                Airport</p>
                        </div>
                        <div class="timing" style="margin-top: 35px;position: relative;left: 30px;">
                            <img style="width:16px;margin-left: 15px;" src="/Images/watch.png" alt="time">
                            <p style="color: #9b9b9b;position: relative;bottom: 12px;">2h 30m</p>
                            <hr style="color: #9b9b9b;width: 50px;margin-right: 110px;position: relative;bottom: 20px;">
                            <p style="color: #9b9b9b;position: relative;bottom: 30px;">Economy</p>
                        </div>
                        <div class="hyderabad-details">
                            <h2 style="font-weight: bold;color: #eb6125;text-align: center;">HYD</h2>
                            <p style="font-size: 11px;position: relative;bottom: 18px;text-align: center;">HYDERABAD</p>
                            <p style="color: #141823;background: #fef8e5;font-weight: bold;text-align: center;position: relative;
                        bottom: 25px;">17:30 hrs, 09 Dec</p>
                            <p style="text-align: center;font-size: 12px;position: relative;bottom: 35px;">Rajiv Gandhi
                    ...
                    <td style="padding:20px 10px">
                        <table align="center"
                            ...
                            <tbody>
                                <tr>
                                    <td
                                        style="padding: 10px 5px;vertical-align: top;font-family: arial;text-align: center;font-size: 12px;
                                        border-right: solid 1px #f4f4f4;color: #4a4a4a;width: 25%;">
                                        1. Himanshu Mehra, Adult</td>
                                    <td
                ...
                <div class="support" style="margin-top: 20px;position: relative;right: 15px;">
                    <div class="grid grid-two-column" style="display: flex;flex-direction: column;flex-wrap: nowrap;align-content: center;
