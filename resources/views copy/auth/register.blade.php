<x-guest-layout>
    <form class="form w-100" novalidate="novalidate" id="kt_sign_up_form"
        data-kt-redirect-url="/" action="{{ route('register') }}" method="POST">
        @csrf
        <!--begin::Heading-->
        ...
        <div class="fv-row mb-8" data-kt-password-meter="true">
            ...
            <div class="mb-1">
                ...
                <div class="position-relative mb-3">
                    <input class="form-control bg-transparent" id="password" type="password" placeholder="Password" name="password"
                        autocomplete="off" />
