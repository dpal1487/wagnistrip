                            ...
                            {{-- <div class="col-sm-2 mt-3"> --}}
                                ...
                                @if($isAgent)
                                    <div class="col-2 col-md-3 col-sm-3 mt-3">
                                        <span class="fontsize-22 ob-fare" data-price1="{{ $itinerariesOutbound['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['TotalFare'] + $Charge }}"> <i class="fa fa-inr"></i>
                                            {{ $itinerariesOutbound['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['TotalFare'] + $Charge }}</span>
                                    </div>
                                @else
                                    <div class="col-2 col-md-3 col-sm-3 mt-3">
                                        <span class="fontsize-22 ob-fare" data-price1="{{ $itinerariesOutbound['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['BaseFare'] }}"> <i class="fa fa-inr"></i>
                                            ...
                                            @foreach ($roundtripOutboundsRecommendation as $recommendation)
                                                ...
                                                @foreach ($segmentFlightRefs as $segmentFlightRef)
                                                    @if ($segmentFlightRef->referencingDetail[0]->refNumber == $outBoundFlights->propFlightGrDetail->flightProposal[0]->ref)
                                                        ...
                                                        @endphp
                                                        @if($isAgent)
                                                        <span class="fontsize-22 ob-fare" data-price1="{{ $paxFareProduct->paxFareDetail->totalFareAmount + $Charge }}"> <i class="fa fa-inr"></i>
                                ...
                                {{--    <div class="col-sm-2 ib-flight"> --}}
                                    ...
                                    {{--    <div class="col-sm-2 mt-3 ib-dur-loc"> col-3 col-md-2 col-sm-2 mt-3 ob-dur-loc ////col-sm-2 mt-3 ib-dur-loc/////  col-3 col-md-2 col-sm-2 mt-3 ob-dur-loc --}}
                                       ...
                                       <div class="col-2 col-md-2 col-sm-2 mt-3">
                                        ...
                                        @if($isAgent)
                                           <div class="col-2 col-md-3 col-sm-3 mt-3">
                                                <span class="fontsize-22 ib-fare" data-price2="{{ $itinerariesInbound['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['TotalFare'] + $Charge}}"> <i class="fa fa-inr"></i>
                                                    {{ $itinerariesInbound['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['TotalFare'] + $Charge }}</span>
                                            </div>
                                        @else
                                           <div class="col-2 col-md-3 col-sm-3 mt-3">
                                                <span class="fontsize-22 ib-fare" data-price2="{{ $itinerariesInbound['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['BaseFare'] }}"> <i class="fa fa-inr"></i>
                                            ...
                                            @foreach ($roundtripInboundsRecommendation as $recommendation)
                                                ...
                                                @foreach ($segmentFlightRefs as $segmentFlightRef)
                                                    @if ($segmentFlightRef->referencingDetail[0]->refNumber == $inBoundFlights->propFlightGrDetail->flightProposal[0]->ref)
                                                        ...
                                                        @endphp
                                                        @if($isAgent)
                                                        <span class="fontsize-22 ib-fare" data-price2="{{ $paxFareProduct->paxFareDetail->totalFareAmount + $Charge }}"> <i class="fa fa-inr"></i>
                                                            {{ $paxFareProduct->paxFareDetail->totalFareAmount + $Charge  }}
                                                        @else
                                                        <span class="fontsize-22 ib-fare" data-price2="{{ $paxFareProduct->paxFareDetail->totalFareAmount - $paxFareProduct->paxFareDetail->totalTaxAmount }}"> <i class="fa fa-inr"></i>
                                                            {{ $paxFareProduct->paxFareDetail->totalFareAmount - $paxFareProduct->paxFareDetail->totalTaxAmount}}
                                                        @endif
                                                            @php
                                                                $totalFareAmount = $paxFareProduct->paxFareDetail->totalFareAmount;
                                            ...
                                            @foreach ($roundtripInboundsRecommendation as $recommendation)
                                                ...
                                                @foreach ($segmentFlightRefs as $segmentFlightRef)
                                                    @if ($segmentFlightRef->referencingDetail[0]->refNumber == $inBoundFlights->propFlightGrDetail->flightProposal[0]->ref)
                                                        ...
                                                        @endphp
                                                        @if($isAgent)
                                                        <span class="fontsize-22 ib-fare" data-price2="{{ $paxFareProduct->paxFareDetail->totalFareAmount + $Charge }}"> <i
                                                                class="fa fa-inr"></i>
                                                            {{ $paxFareProduct->paxFareDetail->totalFareAmount + $Charge }}
                                                        @else
