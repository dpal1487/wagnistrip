                        ...
                        <div class="boxunder p-2">
                            ...
                            <div class="ranjepp">
                                ...
                                <div id="price" class="collapse show">
                                    <span class="font-14">
                                        ...
                                        <i class="fa fa-inr"></i>
                                        {{ array_sum([$response1['FareBreakDowns']['FareBreakDown'][0]['BaseFare'], $response2['FareBreakDowns']['FareBreakDown'][0]['BaseFare']]) . ')' }}
                                    </span>
                                    <span class="float-right fontsize-17"><i class="fa fa-inr"></i>
                                        {{ (int) $travellers['noOfAdults'] * (int) array_sum([$response1['FareBreakDowns']['FareBreakDown'][0]['BaseFare'], $response2['FareBreakDowns']['FareBreakDown'][0]['BaseFare']]) }}</span>
                                </div>
                            </div>
                            ...
                            <div class="ranjepp">
                                ...
                                <div id="price" class="collapse show">
                                    ...
                                    <span class="float-right fontsize-17"><i class="fa fa-inr"></i>
                                        {{ ((int) $travellers['noOfAdults'] * $Charge) +(int) $travellers['noOfAdults'] * (int) array_sum([$response1['FareBreakDowns']['FareBreakDown'][0]['TotalTax'], $response2['FareBreakDowns']['FareBreakDown'][0]['TotalTax']]) }}</span>
                                </div>
                            </div>
                            <div class="border-bottom"></div>
                            <div class="ranjepp">
                            ...
                            <div class="ranjepp">
                                ...
                                <div id="price" class="collapse show">
                                    <span class="font-14">
                                        ...
                                        <i class="fa fa-inr"></i>
                                        {{ $response1['FareBreakDowns']['FareBreakDown'][1]['BaseFare'] . ')' }}
                                    </span>
                                    <span class="float-right fontsize-17"><i class="fa fa-inr"></i>
                                        {{ (int) $travellers['noOfChilds'] * (int) array_sum([$response1['FareBreakDowns']['FareBreakDown'][1]['BaseFare'], $response2['FareBreakDowns']['FareBreakDown'][0]['BaseFare']]) }}</span>
                                </div>
                            </div>
                            <div class="border-bottom"></div>
                            <div class="ranjepp">
                                ...
                                <div id="price" class="collapse show">
                                    <span class="font-14">Total Fee & Surcharges : </span>
                                    <span class="float-right fontsize-17"><i class="fa fa-inr"></i>
                                        {{ array_sum([$response1['Total']['FuelSurcharge']+$Charge, $response2['Total']['FuelSurcharge']+$Charge, $response1['Total']['OtherTax'], $response2['Total']['OtherTax']]) }}</span>
                                </div>
                            </div>
                            <div class="border-bottom"></div>
                            <div class="ranjepp">
                            ...
                            <div class="ranjepp">
                                ...
                                <div id="price" class="collapse show">
                                    <span class="font-14">
                                        ...
                                        <i class="fa fa-inr"></i>
                                        {{ array_sum([$response1['FareBreakDowns']['FareBreakDown'][1]['BaseFare'], $response2['FareBreakDowns']['FareBreakDown'][1]['BaseFare']]) . ')' }}
                                    </span>
                                    <span class="float-right fontsize-17"><i class="fa fa-inr"></i>
                                        {{ (int) $travellers['noOfInfants'] * (int) array_sum([$response1['FareBreakDowns']['FareBreakDown'][1]['BaseFare'], $response2['FareBreakDowns']['FareBreakDown'][1]['BaseFare']]) }}</span>
                                </div>
                            </div>
                            <div class="border-bottom"></div>
                            <div class="ranjepp">
                                ...
                                <div id="price" class="collapse show">
                                    <span class="font-14">Total Fee & Surcharges : </span>
                                    <span class="float-right fontsize-17"><i class="fa fa-inr"></i>
                                        {{ array_sum([$response1['Total']['FuelSurcharge'], $response1['Total']['OtherTax']+$Charge, $response2['Total']['FuelSurcharge'], $response2['Total']['OtherTax']+$Charge]) }}</span>
                                </div>
                            </div>
                            <div class="border-bottom"></div>
                            <div class="ranjepp">
                        ...
                        <div class="boxunder p-2">
                            ...
                            <div class="ranjepp">
                                ...
                                <div id="price" class="collapse show">
                                    ...
                                    <span class="float-right fontsize-17"><i class="fa fa-inr"></i>
                                        {{ (int) $travellers['noOfChilds'] * (int) array_sum([$response1['FareBreakDowns']['FareBreakDown'][1]['BaseFare'], $response2['FareBreakDowns']['FareBreakDown'][1]['BaseFare']]) }}</span>
                                </div>
                                <div id="price" class="collapse show">
                                    <span class="font-14">
                                        {{ $response1['FareBreakDowns']['FareBreakDown'][2]['PaxType'] . '(' . $travellers['noOfInfants'] . 'X' }}
                                        <i class="fa fa-inr"></i>
                                        {{ array_sum([$response1['FareBreakDowns']['FareBreakDown'][2]['BaseFare'], $response2['FareBreakDowns']['FareBreakDown'][2]['BaseFare']]) . ')' }}
                                    </span>
                                    <span class="float-right fontsize-17"><i class="fa fa-inr"></i>
                                        {{ (int) $travellers['noOfInfants'] * (int) array_sum([$response1['FareBreakDowns']['FareBreakDown'][2]['BaseFare'], $response2['FareBreakDowns']['FareBreakDown'][2]['BaseFare']]) }}</span>
                                </div>
                            </div>
                            <div class="border-bottom"></div>
                            <div class="ranjepp">
                                ...
                                <div id="price" class="collapse show">
                                    <span class="font-14">Total Fee & Surcharges : </span>
                                    <span class="float-right fontsize-17"><i class="fa fa-inr"></i>
                                        {{ array_sum([$response1['Total']['FuelSurcharge']+$Charge, $response1['Total']['OtherTax'], $response2['Total']['FuelSurcharge']+$Charge, $response2['Total']['OtherTax']]) }}</span>
                                </div>
                            </div>
                            <div class="border-bottom"></div>
                            <div class="ranjepp">
