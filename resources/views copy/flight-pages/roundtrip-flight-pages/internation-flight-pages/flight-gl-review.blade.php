                        ...
                        <div class="boxunder p-2">
                            ...
                            <div class="ranjepp">
                                ...
                                <div id="price" class="collapse show">
                                    <span class="font-14">Total Fee & Surcharges : </span>
                                    <span class="float-right fontsize-17"><i class="fa fa-inr"></i>
                                        {{ array_sum([$response['AirPricingResponse'][0]['PricingInfos']['PricingInfo'][0]['Total']['FuelSurcharge']+ ( (int) $travellers['noOfAdults'] * $Charge)+ ( (int) $travellers['noOfChilds'] * $Charge), $response['AirPricingResponse'][0]['PricingInfos']['PricingInfo'][0]['Total']['OtherTax']]) }}</span>
                                </div>
                            </div>
                            <div class="border-bottom"></div>
                            <div class="ranjepp">
