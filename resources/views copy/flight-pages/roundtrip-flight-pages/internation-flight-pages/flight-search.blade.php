                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3 bor">
                                <div onclick="rotriprice()">
                                    <span class="owstitle"> <i class="fa fa-rupee"></i> Price </span>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 col-md-6 col-sm-6">
                                <div class="row ranjepp  ranjepp_012" style="  width: 60%;float: right;">
                                    ...
                                    <div class="col-6 col-md-6  col-sm-6">
                                        @if($isAgent)
                                        <span class="fontsize-22 fare dataprice margin-20 col_ok_ok " data-price1="{{ $availability['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['TotalFare'] + $charge }}"><i class="fa fa-rupee"></i>
                                            {{ $availability['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['TotalFare'] + $charge }}
                                        </span>
                                        @else
                                        <span class="fontsize-22 fare dataprice margin-20 col_ok_ok " data-price1="{{ $availability['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['TotalFare'] }}"><i class="fa fa-rupee"></i>
                                            {{ $availability['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['TotalFare'] }}
                                        </span>
                                        @endif
                                    </div>
                                    <div class="col-6 col-md-6 col-sm-6">
                                        ...
                                        <tbody class="onwfntrespons-11">
                                            <tr>
                                                ...
                                                <td class="text-right"> <i class="fa fa-inr"></i>
                                                    {{ $availability['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['BaseFare'] }}
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right"> <i class="fa fa-inr"></i>
                                                    {{ $availability['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['TotalTax'] }}
                                                </td>
                                            </tr>
                                            <tr>
                            ...
                            <div class="col-6 col-md-6 col-sm-6">
                                <div class="row ranjepp">
                                    ...
                                    <div class="col-4 col-md-4 col-md-4">
                                            @php
                                                $totalFareAmount = $recommendation->paxFareProduct->paxFareDetail->totalFareAmount;
                                                $totalTaxAmount = $recommendation->paxFareProduct->paxFareDetail->totalTaxAmount;
                                            @endphp
                                            @if($isAgent)
                                        <span class="fontsize-22 fare dataprice margin-20" data-price1="{{ $recommendation->paxFareProduct->paxFareDetail->totalFareAmount + $charge }}"><i class="fa fa-rupee"></i>
                                            {{ $recommendation->paxFareProduct->paxFareDetail->totalFareAmount + $charge }}</span>
                                            @else
                                        <span class="fontsize-22 fare dataprice margin-20" data-price1="{{ $recommendation->paxFareProduct->paxFareDetail->totalFareAmount }}"><i class="fa fa-rupee"></i>
                                            {{ $recommendation->paxFareProduct->paxFareDetail->totalFareAmount }}</span>
