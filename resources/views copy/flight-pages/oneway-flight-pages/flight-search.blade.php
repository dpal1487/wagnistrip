...
<section class="flightresultsection">
    <div class="container">
        <div class="row">
            <aside class="airlineFilter col-sm-3">
                <div class="filterstickydiv">                
                    <div class="commonTitle_1 cursorPointer  filterheads fontWeight_600 mb-2" data-toggle="collapse" data-target="#FILTER" aria-expanded="true">FILTER <span class="float-right"><i class="fa fa-arrow-down" aria-hidden="true"></i></span></div>
                    <div class="bg-white filtersinnerdiv">
                        <div class="collapse show" id="FILTER">
                            <div class="accFiltesDiv">
                                <div class="commonDesc filterheads cursorPointer fontWeight_600" data-toggle="collapse" data-target="#Stops2,#Airline2" aria-expanded="true">Popular Filters <span class="float-right"><i class="fa fa-arrow-down" aria-hidden="true"></i></span></div>
                                <div id="Stops2" class="collapse show mb-2 p-2">
                                    <div class="filterinputdiv d-flex align-items-center py-1">
                                        <input type="checkbox" value="AI">                                
                                        <label class="d-block fontWeight_600">1-Stop</label>
                                    </div>
                                    <div class="filterinputdiv d-flex align-items-center py-1">
                                        <input type="checkbox" value="AI">                                
                                        <label class="d-block fontWeight_600">Non-Stop</label>
                                    </div>
                                    <div class="filterinputdiv d-flex align-items-center py-1">
                                        <input type="checkbox" value="AI">
                                        <img src="https://www.flights.wagnistrip.com/assets/images/flight/AI.png" width="16px" height="16px">
                                    ...
                                    <div class="filterinputdiv d-flex align-items-center py-1">
                                        <input type="checkbox" value="AI">
                                        <img src="https://www.flights.wagnistrip.com/assets/images/flight/6E.png" width="16px" height="16px">
                                        <label class="d-block fontWeight_600">IndiGo</label>
                                    </div>
                                    <div class="filterinputdiv d-flex align-items-center py-1">
                                        <input type="checkbox" value="AI">
                                        <img src="https://www.flights.wagnistrip.com/assets/images/flight/UK.png" width="16px" height="16px">
                            ...
                            <div class="accFiltesDiv">                            
                                <div class="commonDesc filterheads cursorPointer fontWeight_600" data-toggle="collapse" data-target="#price">Pricing <span class="float-right"><i class="fa fa-arrow-down" aria-hidden="true"></i></span></div>
                                <div id="price" class="collapse show mb-2 p-2">
                                    <div class="wrapper text-center">                                
                                        <div class="text-center" style=" margin-top: 1rem; width:100%; ">
                                        ...
                                        <select class="form-control1 w-100 border rounded-10 commonDesc mt-4  text-center cursorPointer" name="price-sorting">
                            ...
                            <div class="accFiltesDiv">
                                <div class="commonDesc filterheads cursorPointer fontWeight_600" data-toggle="collapse" data-target="#FLIGHT">FLIGHT TIMING <span class="float-right"><i class="fa fa-arrow-down" aria-hidden="true"></i></span></div>
                                <div id="FLIGHT" class="collapse show price-filter-container">                            
                                    <i class="p-2 d-block">Departure <span id="city1"></span></i>
                                    <div class="slider-wrapper slider-primary slider-strips slider-ghost p-2">
                                    ...
                                    <i class="p-2 d-block">Arrival <span id="city2"></span></i>
                                    <div class="slider-wrapper slider-primary slider-strips slider-ghost p-2">
                                        <div class="d-flex justify-content-between">
                                            <div class="col-md-3 p-1 timeBTN">
            ...
            <div class="itnerydetailrightside col-sm-9">
                <div class="datesSlider"></div>
                ...
                @foreach ($availability['Availibilities'][0]['Availibility'] as $AvailKey => $itineraries)
                    ...
                    <div class="flightcardwrapper bg-white rounded-10 1-Stop {{ $itineraries['Itineraries']['Itinerary'][0]['AirLine']['Code']. ' ' . $itineraries['Itineraries']['Itinerary'][0]['Destination']['AirportCode']}} " data-price1="{{ $itineraries['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['TotalFare'] }}">
                        <div class="detailinner d-flex justify-content-between align-items-center flex-wrap-in-mb">
                            <div class="leftdetailinner col-sm-9">
                                <div class="airlinelogodiv row">
                                    <div class="col-2">
                                        <img src="{{ asset('assets/images/flight/' . $itineraries['Itineraries']['Itinerary'][0]['AirLine']['Code']) }}.png" alt="airline" class="airlineimg" loading="lazy">
                                    </div>
                                    <div class="airlinename">
                                        <span class="commonpera d-block fontWeight_600">{{ ($itineraries['Itineraries']['Itinerary'][0]['AirLine']['Name'])??($itineraries['Itineraries']['Itinerary'][0]['AirLine']['Name']) }}</span>
                                        <span class="commonpera d-block fontWeight_600">{{ $itineraries['Itineraries']['Itinerary'][0]['AirLine']['Code'] . '-' . $itineraries['Itineraries']['Itinerary'][0]['AirLine']['Identification'] }}</span>
                                    </div>
                                </div>
                                <div class="airlinedetails d-flex justify-content-between align-items-center">
                                    <div class="divleft col-4">
                                        <div class="commonDesc fontWeight_600" data-city1="{{ $itineraries['Itineraries']['Itinerary'][0]['Origin']['CityName'] . ' (' . $itineraries['Itineraries']['Itinerary'][0]['Origin']['AirportCode'] . ')' }}">{{ $itineraries['Itineraries']['Itinerary'][0]['Origin']['CityName'] . ' (' . $itineraries['Itineraries']['Itinerary'][0]['Origin']['AirportCode'] . ')' }} <span class="commonDesc fontWeight_600">{{ getTimeFormat($itineraries['Itineraries']['Itinerary'][0]['Origin']['DateTime']) }}</span> </div>
                                        <span class="fontWeight_600 graytext">{{ getDateFormat($itineraries['Itineraries']['Itinerary'][0]['Origin']['DateTime']) }}</span>
                                    </div>
        
                                    <div class="middiv col-3 text-center">
                                        <div class="commonDesc fontWeight_600">{{ $itineraries['Itineraries']['Itinerary'][0]['Duration'] }}</div>
                                        <div class="borderbottom"></div>
                                        <span class="graytext fontWeight_600">1-Stop</span>
                                    </div>
        
                                    <div class="divleft col-4">
                                        <div class="commonDesc fontWeight_600" data-city2="{{ $itineraries['Itineraries']['Itinerary'][1]['Destination']['CityName'] . ' (' . $itineraries['Itineraries']['Itinerary'][1]['Destination']['AirportCode'] . ')' }}">{{ $itineraries['Itineraries']['Itinerary'][1]['Destination']['CityName'] . ' (' . $itineraries['Itineraries']['Itinerary'][1]['Destination']['AirportCode'] . ')' }} <span class="commonDesc fontWeight_600">{{ getTimeFormat($itineraries['Itineraries']['Itinerary'][1]['Destination']['DateTime']) }}</span> </div>
                                        <span class="graytext fontWeight_600">{{ getDateFormat($itineraries['Itineraries']['Itinerary'][1]['Destination']['DateTime']) }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="buttonsdiv col-sm-3 text-center m-auto">
                                <form action="{{ route('galileo-pricing') }}" method="POST">
                                    ...
                                    @if($isAgent)
                                   <strong class=" TotalFare product-card commonTitle_1 fontWeight_600 d-block pricetext" data-price1="{{ $itineraries['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['TotalFare'] + $charge }}"> <i class="fa fa-rupee"></i>{{ $itineraries['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['TotalFare'] + $charge }}</strong>

                                    @else
                                   <strong class=" TotalFare product-card commonTitle_1 fontWeight_600 d-block pricetext" data-price1="{{ $itineraries['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['BaseFare'] }}"> <i class="fa fa-rupee"></i> {{ $itineraries['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['BaseFare'] }}</strong>

                                    @endif
                                    </span>

                                    <a class="btn btn-sm submit-btn blueBtn commonTitle_1 w-100">Book Now</a>
                        ...
                        <div class="collapseblediv d-flex justify-content-end">
                            <span data-toggle="collapse" data-target="#flight-details{{ $AvailKey }}" class="onewflydetbtn commonDesc fontWeight_600 butonborderd" aria-expanded="true">Flight Details <i class="fa fa-regular fa-angle-down"></i></span>
                        </div>
                        <div id="flight-details{{ $AvailKey }}" class="collapse flightcolaspsedetails">
                            <div class="wrapperdiv">
                                <ul class="nav nav-tabs">
                                    <li class="nav-item"> <a class="nav-link commonpera fontWeight_600 active" data-toggle="tab" href="#Information{{ $AvailKey }}"> Flight Information </a></li>
                                    <li class="nav-item"> <a class="nav-link commonpera fontWeight_600" data-toggle="tab" href="#Details{{ $AvailKey }}"> Fare Details </a></li>
                                    <li class="nav-item"> <a class="nav-link commonpera fontWeight_600" data-toggle="tab" href="#Baggage{{ $AvailKey }}">Baggage Information </a></li>
                                    <li class="nav-item"> <a class="nav-link commonpera fontWeight_600" data-toggle="tab" href="#Cancellation{{ $AvailKey }}">Cancellation Rules </a></li>
                                </ul>

                                <div class="tab-content">
                                    <div class="tab-pane active" id="Information{{ $AvailKey }}">
                                        <div class="airCodetext py-2">
                                            <span class="commonDesc fontWeight_600">{{$itineraries['Itineraries']['Itinerary'][0]['Origin']['AirportCode']}} <span class="nextarrow">→</span> {{$itineraries['Itineraries']['Itinerary'][0]['Destination']['AirportCode']}} </span>
                                            <span class="commonpera fontWeight_600">{{ getDateFormat($itineraries['Itineraries']['Itinerary'][0]['Origin']['DateTime']) }}</span>
                                        </div>
                                        <div class="row">
                                            <div class="col-2 col-md-2 col-sm-2">
                                                <img src="{{ asset('assets/images/flight/' . $itineraries['Itineraries']['Itinerary'][0]['AirLine']['Code']) }}.png" alt="fligt" class="airlineimg" loading="lazy">
                                                <span class="d-block fontWeight_600">{{ $itineraries['Itineraries']['Itinerary'][0]['AirLine']['Code'] . '-' . $itineraries['Itineraries']['Itinerary'][0]['AirLine']['Identification'] }}</span>
                                            </div>
                                            <div class="col-3 col-md-3 col-sm-3 text-center">
                                                <div class="commonDesc fontWeight_600">{{ getTimeFormat($itineraries['Itineraries']['Itinerary'][0]['Origin']['DateTime']) }}</div>
                                                <div class="commonpera fontWeight_600">{{ $itineraries['Itineraries']['Itinerary'][0]['Origin']['CityName'] . '(' . $itineraries['Itineraries']['Itinerary'][0]['Origin']['AirportCode'] . ')' }}</div>
                                                <div class="commonpera fontWeight_600">{{ getDateFormat($itineraries['Itineraries']['Itinerary'][0]['Origin']['DateTime']) }}</div>
                                            </div>
                                            <div class="col-3 col-md-3 col-sm-3 text-center">
                                                <span class="commonTitle_600 watchicon"><svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" width="18" height="18" x="0" y="0" viewBox="0 0 682.667 682.667" style="enable-background:new 0 0 512 512" xml:space="preserve" class=""><g><defs><clipPath id="a" clipPathUnits="userSpaceOnUse"><path d="M0 512h512V0H0Z" fill="#000000" data-original="#000000"></path></clipPath></defs><g clip-path="url(#a)" transform="matrix(1.33333 0 0 -1.33333 0 682.667)"><path d="M0 0c0-133.101-107.899-241-241-241S-482-133.101-482 0s107.899 241 241 241S0 133.101 0 0Z" style="stroke-width:30;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;stroke-dasharray:none;stroke-opacity:1" transform="translate(497 256)" fill="none" stroke="#000000" stroke-width="30" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-dasharray="none" stroke-opacity="" data-original="#000000" class=""></path><path d="M0 0v-41.698" style="stroke-width:30;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;stroke-dasharray:none;stroke-opacity:1" transform="translate(256 497)" fill="none" stroke="#000000" stroke-width="30" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-dasharray="none" stroke-opacity="" data-original="#000000" class=""></path><path d="M0 0v-41.698" style="stroke-width:30;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;stroke-dasharray:none;stroke-opacity:1" transform="translate(256 56.698)" fill="none" stroke="#000000" stroke-width="30" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-dasharray="none" stroke-opacity="" data-original="#000000" class=""></path><path d="M0 0h41.698" style="stroke-width:30;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;stroke-dasharray:none;stroke-opacity:1" transform="translate(15 256)" fill="none" stroke="#000000" stroke-width="30" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-dasharray="none" stroke-opacity="" data-original="#000000" class=""></path><path d="M0 0h51.698" style="stroke-width:30;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;stroke-dasharray:none;stroke-opacity:1" transform="translate(445.302 256)" fill="none" stroke="#000000" stroke-width="30" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-dasharray="none" stroke-opacity="" data-original="#000000" class=""></path><path d="m0 0 26.556-26.556" style="stroke-width:30;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;stroke-dasharray:none;stroke-opacity:1" transform="translate(85.587 426.412)" fill="none" stroke="#000000" stroke-width="30" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-dasharray="none" stroke-opacity="" data-original="#000000" class=""></path><path d="m0 0 26.557-26.556" style="stroke-width:30;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;stroke-dasharray:none;stroke-opacity:1" transform="translate(399.856 112.144)" fill="none" stroke="#000000" stroke-width="30" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-dasharray="none" stroke-opacity="" data-original="#000000" class=""></path><path d="m0 0-26.556-26.557" style="stroke-width:30;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;stroke-dasharray:none;stroke-opacity:1" transform="translate(426.412 426.413)" fill="none" stroke="#000000" stroke-width="30" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-dasharray="none" stroke-opacity="" data-original="#000000" class=""></path><path d="m0 0-26.556-26.557" style="stroke-width:30;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;stroke-dasharray:none;stroke-opacity:1" transform="translate(112.144 112.144)" fill="none" stroke="#000000" stroke-width="30" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-dasharray="none" stroke-opacity="" data-original="#000000" class=""></path><path d="M0 0v-139.302h94.651" style="stroke-width:30;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;stroke-dasharray:none;stroke-opacity:1" transform="translate(256 395.302)" fill="none" stroke="#000000" stroke-width="30" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-dasharray="none" stroke-opacity="" data-original="#000000" class=""></path></g></g></svg></span>
                                                 
                                                @php 
                                                   $seconds = []; 
                                                $timess = [getTimeFormat($itineraries['Itineraries']['Itinerary'][0]['Origin']['DateTime'])];
                                                $times = [getTimeFormat($itineraries['Itineraries']['Itinerary'][0]['Destination']['DateTime'])];
                                                 $time = array_merge($timess, $times);
                                                foreach(array_chunk($time, 2) as $t){
                                                    $seconds[] = strtotime($t[1])-strtotime($t[0]);
                                                }

                                                $firststop = floor(array_sum($seconds)/3600);
                                                $mi = (array_sum($seconds)%3600)/60;
                                                @endphp
                                                <div class="commonDesc fontWeight_600">{{$firststop}}h : {{$mi}}m</div>
                                               
                                            </div>
                                            <div class="col-4 col-md-4 col-sm-4 float-right text-center">
                                                <div class="commonDesc fontWeight_600">{{ getTimeFormat($itineraries['Itineraries']['Itinerary'][0]['Destination']['DateTime']) }}</div>
                                                <div class="commonpera fontWeight_600">{{ $itineraries['Itineraries']['Itinerary'][0]['Destination']['CityName'] . '(' . $itineraries['Itineraries']['Itinerary'][0]['Destination']['AirportCode'] . ')' }}</div>
                                                <div class="commonpera fontWeight_600">{{ getDateFormat($itineraries['Itineraries']['Itinerary'][0]['Destination']['DateTime']) }}</div>
                                            </div>
                                            @php
                                               $secondss = [];
                                               $lay1 = [getTimeFormat($itineraries['Itineraries']['Itinerary'][0]['Destination']['DateTime'])];
                                               $lay2 = [getTimeFormat($itineraries['Itineraries']['Itinerary'][1]['Origin']['DateTime'])];
                                               if($lay1[0] > '12:00'){
                                                   $times = array_merge($lay2, $lay1);
                                                }else if($lay1[0] > '12:00' && $lay2[0] > '12:00'){
                                                   
                                                    $times = array_merge($lay1, $lay2);
                                                }
                                                else{
                                                    $times = array_merge($lay1, $lay2);

                                                }
                                                foreach(array_chunk($times, 2) as $t){
                                                    $secondss[] = strtotime($t[1])-strtotime($t[0]);
                                                }

                                                $layH = floor(array_sum($secondss)/3600);
                                                $layM = (array_sum($secondss)%3600)/60;
                                                
                                            @endphp

                                            <div class="col-12 col-md-12 col-sm-12 text-center layorDiv"> <span class="layoretext">LAYOVER: {{getTimeDff_formated( $itineraries['Itineraries']['Itinerary'][0]['Destination']['DateTime'] , $itineraries['Itineraries']['Itinerary'][1]['Origin']['DateTime'])}}</span> </div>
                                            
                                            <div class="col-12 col-md-12 col-sm-12 airCodetext py-2">
                                                <span class="commonDesc fontWeight_600">{{ $itineraries['Itineraries']['Itinerary'][1]['Origin']['AirportCode'] }} => {{ $itineraries['Itineraries']['Itinerary'][1]['Destination']['AirportCode'] }} </span>
                                                <span class="commonpera fontWeight_600">{{ getDateFormat($itineraries['Itineraries']['Itinerary'][1]['Origin']['DateTime']) }}</span>
                                            </div>

                                            <div class="col-2 col-md-2 col-sm-2">
                                                <img src="{{ asset('assets/images/flight/' . $itineraries['Itineraries']['Itinerary'][1]['AirLine']['Code']) }}.png" alt="fligt" class="airlineimg" loading="lazy">
                                                <span class="d-block fontWeight_600">{{ $itineraries['Itineraries']['Itinerary'][1]['AirLine']['Code'] . '-' . $itineraries['Itineraries']['Itinerary'][1]['AirLine']['Identification'] }}</span>
                                            </div>

                                            <div class="col-3 col-md-3 col-sm-3 text-center">
                                                <div class="commonDesc fontWeight_600">{{ getTimeFormat($itineraries['Itineraries']['Itinerary'][1]['Origin']['DateTime']) }}</div>
                                                <div class="commonpera fontWeight_600">{{ $itineraries['Itineraries']['Itinerary'][1]['Origin']['CityName'] . '(' . $itineraries['Itineraries']['Itinerary'][1]['Origin']['AirportCode'] . ')' }}</div>
                                                <div class="commonpera fontWeight_600">{{ getDateFormat($itineraries['Itineraries']['Itinerary'][1]['Origin']['DateTime']) }}</div>
                                            </div>
                                            ...
                                            <div class="col-3 col-md-3 col-sm-3 text-center">
                                                ...
                                                @php 
                                                   $seconds = []; 
                                                $timess = [getTimeFormat($itineraries['Itineraries']['Itinerary'][1]['Origin']['DateTime'])];
                                                $times = [getTimeFormat($itineraries['Itineraries']['Itinerary'][1]['Destination']['DateTime'])];
                                                 $time = array_merge($timess, $times);
                                                foreach(array_chunk($time, 2) as $t){
                                                    $seconds[] = strtotime($t[1])-strtotime($t[0]);
                                                }
                                            ...
                                            <div class="col-4 col-md-4 col-sm-4 float-right text-center">
                                                <div class="commonDesc fontWeight_600">{{ getTimeFormat($itineraries['Itineraries']['Itinerary'][1]['Destination']['DateTime']) }}</div>
                                                <div class="commonpera fontWeight_600">{{ $itineraries['Itineraries']['Itinerary'][1]['Destination']['CityName'] . '(' . $itineraries['Itineraries']['Itinerary'][1]['Destination']['AirportCode'] . ')' }}</div>
                                                <div class="commonpera fontWeight_600">{{ getDateFormat($itineraries['Itineraries']['Itinerary'][1]['Destination']['DateTime']) }}</div>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="tab-pane container fade" id="Details{{ $AvailKey }}">

                                        <div class="faretextdiv pb-2">
                                            <span class="text-left commonTitle_1 fontWeight_600"> Fare Rules :</span>
                                            <span class="text-right Refundable butonborderd greenborderd">Refundable</span>
                                        </div>
                                        <table class="table table-bordered">
                                            <tbody class="onwfntrespons-11"> 
                                                <tr>
                                                    <td class="commonpera fontWeight_500">1 Adult</td>
                                                    <td class="text-right"> <i class="fa fa-inr"></i>4255</td>
                                                </tr>
                                                <tr>
                                                    <td class="commonpera fontWeight_500">Total (Base Fare)</td>
                                                    <td class="text-right"> <i class="fa fa-inr"></i>4255</td>
                                                </tr>
                                                <tr>
                                                    <td class="commonpera fontWeight_500">Total Tax +</td>
                                                    <td class="text-right"> <i class="fa fa-inr"></i>959</td>
                                                </tr>
                                                <tr>
                                                    <td class="commonpera fontWeight_500">Total (Fee &amp; Surcharge)</td>
                                                    <td class="text-right"> <i class="fa fa-inr"></i>5214</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    ...
                                    <div class="tab-pane container fade" id="Baggage{{ $AvailKey }}">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="d-flex align-items-center"> 
                                                        <img src="https://www.flights.wagnistrip.com/assets/images/flight/UK.png" alt="" class="airlineimg" loading="lazy">
                                                        <span class="commonpera fontWeight_500 pl-2">UK-929</span>
                                                    </td>
                                                    <td class="commonpera fontWeight_500">1PC</td>
                                                    <td class="commonpera fontWeight_500">7KG</td>
                                                </tr>
                                                <tr>
                                                    <td> 
                                                        <img src="https://www.flights.wagnistrip.com/assets/images/flight/UK.png" alt="" class="airlineimg" loading="lazy">
                                        ...
                                        <span class="commonpera fontWeight_500 font-weight-bold">Terms &amp; Conditions</span>
                                        <ul class="commonpera fontWeight_500">
                                    ...
                                    <div class="tab-pane container fade" id="Cancellation{{ $AvailKey }}">
                                        <table class="table table-bordered">
                                            <tbody class="onwfntrespons-11">
                                                <tr>
                                                    <td> 
                                                        <b>Time Frame to Reissue</b>
                                                        <div class="commonpera fontWeight_500">(Before scheduled departure time) </div>
                                                    </td>
                                                    <td> 
                                                        <b>Airline Fees</b>
                                                        <div class="commonpera fontWeight_500"> (per passenger) </div>
                                                    </td>
                                                    <td> 
                                                        <b>WT Fees</b>
                                                        <div class="commonpera fontWeight_500"> (per passenger) </div>
                                                ...
                                                <tr>
                                                    <td class="commonpera fontWeight_500">Cancel Before 4 hours of departure time.</td>
...
<section class="flightresultsection" style="display: none;">
    <div class="container">
        <div class="row">
                                    ...
                                    <div class="boxunder grid-item takingoff">
                                        ...
                                        <div class="boxunder">
                                            ...
                                            <div class="col-2 col-md-2 col-sm-2 text-center">
                                                ...
                                                <div class="borderbotum"></div>
                                                <div class="searchtitle colorgrey  text-center">1-Stop</div>
                                            </div>
