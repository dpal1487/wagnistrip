...
class CartController extends Controller
{
    ...
    public function paymentSave(Request $request)
    {
        ...
        $sDetail->save();
        return view('payment', compact('data', 'trip'));
    }
    ...
    public function PaymentSaveGalelio(Request $request)
    {
        ...
        return view('flight-pages.oneway-flight-pages.payment', compact('data'));
    }
    ...
    public function PaymentSaveGalelioRoundTrip(Request $request)
    {
       ...
       // dd($data);
        return view('flight-pages.roundtrip-flight-pages.domestic-flight-pages.gl-payment', compact('data'));
    }
