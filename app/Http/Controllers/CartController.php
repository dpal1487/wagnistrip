...
class CartController extends Controller {
    ...
    public function paymentSave(Request $request) 
    {
       ...
       $url=[
        ...
        return view('payment', compact('data', 'trip' , 'travller' , 'sDetail' , 'flightdata' ,'input' , 'url', 'bankData', 'otherInformations'));
    }
    ...
    public function PaymentSaveGalelio(Request $request)
    {
        ...
        if($input['trip']=='Internation-Roundtrip'){
            ...
            return view('payment', compact('sDetail','data', 'trip', 'travller', 'requsData','flightdata','input', 'postData', 'signature', 'bankData', 'url'));
        }
        // dd($request->all());
    ...
    //     }
       ...
       // dd($input,$flightdata,$passengers,$travellerDetails);
        ...
        return view('flight-pages.roundtrip-flight-pages.domestic-flight-pages.gl-payment', compact('input','data' ,'bankData'));
    }
