...
class HotelBookingController extends Controller
{
    public  function HotelReview(Request $request)
    {
        ...
        if(!isset($detail['OTA_HotelAvailRS'])){
            ...
            return view('hotel-pages.review-hotel', compact('detail', 'header', 'requestDetails'));
        }
        // dd($detail);
    }
    ...
    public function HotelPay(Request $request){
        $data = $request->all(); 
        return view('hotel-pages.payment', compact('data'));
    }
    ...
    public function HotelAddPax(Request $request) 
    {
        ...
        $resultSellRetrive = HeaderController::xmlCallWithBodyAndHeader2($xmlsellRetrive, "PNRADD_17_1_1A_10");
     ...
     //dd($resultsellRetriveRepeat);
        return view('hotel-pages.ticket', compact('resultsellRetriveRepeat','postvalue'));
