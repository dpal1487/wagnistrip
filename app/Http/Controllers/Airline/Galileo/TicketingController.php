            ...
            if ($buzz['status'] == 'success') {
                ...
                if (isset($Booking['Status'])) {
                    ...
                    if (isset($Ticket['Status'])) {
                        ...
                        //     // $saveBooking->save()->(new SendMailController); 
                        //     // dd($saveBooking , $getBooking['AirBookingResponse'][0]);
                        //      $bookings['bookings'] = $saveBooking;
                                            
                        //     $bookings['email'] =  $email??$useremail[0]?? 'customercare@wagnistrip.com';
                        //     $bookings['title'] =   "Flight Ticket ".json_encode($bookingData['name'])??'guest';
                ...
                for ($i = 1; $i <= 2; $i++) {
                    ...
                    if (isset($Booking['Status'])) {
                        ...
                        if (isset($Ticket['Status'])) {
                            ...
                            //         return view('flight-pages.booking-confirm.roundtrip-gal-flight-booking-confirm')->with('bookings', $saveBooking);
                            //     }
                            // } else
                            if  (($getBooking['Status'] == "Hold")|| ($getBooking['Status'] == "Success")) {
                                $FareInformation[] = [
