...
$('INPUT:radio[name=adult], INPUT:radio[name=child]').change(function() {

    if ($(this).is(':checked') === true) {

        var adult = parseInt($('INPUT:radio[name=adult]:checked').val());
        var child = parseInt($('INPUT:radio[name=child]:checked').val());

        $('#total_room').html(1);
        $('#total_guest').html(adult + child);
